...
!function(){function e(e,t,n,i,a,r){function o(i,o,s,l,u){function d(){R.resizeRequiresRefresh(b.__clientWidth,b.__clientHeight)&&g()}function f(){var e;return e={dataLength:0,width:0,height:0,resizeRequiresRefresh:function(t,n){var i=e.dataLength&&t&&n&&(t!==e.width||n!==e.height);return e.width=t,e.height=n,!!i},dataChangeRequiresRefresh:function(t){var n=t.length>0||t.length<e.dataLength;return e.dataLength=t.length,!!n}}}function h(){return j||(j=new e({afterItemsNode:L[0],containerNode:S,heightData:x,widthData:A,forceRefreshImages:!(!c(s.forceRefreshImages)||"false"===s.forceRefreshImages),keyExpression:T,renderBuffer:P,scope:i,scrollView:l.scrollView,transclude:u}))}function p(){var e=angular.element(b.__content.querySelector(".collectaui-repeat-after-container"));if(!e.length){var t=!1,n=[].filter.call(b.__content.childNodes,function(e){return atajoui.DomUtil.contains(e,S)?(t=!0,!1):t});e=angular.element('<span class="collectaui-repeat-after-container">'),b.options.scrollingX&&e.addClass("horizontal"),e.append(n),b.__content.appendChild(e[0])}return e}function v(){_?m(_,x):x.computed=!0,D?m(D,A):A.computed=!0}function g(){var e=V.length>0;if(e&&(x.computed||A.computed)&&w(),e&&x.computed){if(x.value=U.height,!x.value)throw new Error('collectaui-repeat tried to compute the height of repeated elements "'+k+'", but was unable to. Please provide the "item-height" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/')}else!x.dynamic&&x.getValue&&(x.value=x.getValue());if(e&&A.computed){if(A.value=U.width,!A.value)throw new Error('collectaui-repeat tried to compute the width of repeated elements "'+k+'", but was unable to. Please provide the "item-width" attribute. http://ionicframework.com/docs/api/directive/collectionRepeat/')}else!A.dynamic&&A.getValue&&(A.value=A.getValue());h().refreshLayout()}function m(e,n){if(e){var i;try{i=t(e)}catch(a){e.trim().match(/\d+(px|%)$/)&&(e='"'+e+'"'),i=t(e)}var r=e.replace(/(\'|\"|px|%)/g,"").trim(),o=r.length&&!/([a-zA-Z]|\$|:|\?)/.test(r);if(n.attrValue=e,o)if(e.indexOf("%")>-1){var s=parseFloat(i())/100;n.getValue=n===x?function(){return Math.floor(s*b.__clientHeight)}:function(){return Math.floor(s*b.__clientWidth)}}else n.value=parseInt(i());else n.dynamic=!0,n.getValue=n===x?function(e,t){var n=i(e,t);return n.charAt&&"%"===n.charAt(n.length-1)?Math.floor(parseFloat(n)/100*b.__clientHeight):parseInt(n)}:function(e,t){var n=i(e,t);return n.charAt&&"%"===n.charAt(n.length-1)?Math.floor(parseFloat(n)/100*b.__clientWidth):parseInt(n)}}}function w(){N||u(z=i.$new(),function(e){e[0].removeAttribute("collectaui-repeat"),N=e[0]}),z[T]=(I(i)||[])[0],a.$$phase||z.$digest(),S.appendChild(N);var e=n.getComputedStyle(N);U.width=parseInt(e.width),U.height=parseInt(e.height),S.removeChild(N)}var b=l.scrollView,y=o[0],S=angular.element('<div class="collectaui-repeat-container">')[0];if(y.parentNode.replaceChild(S,y),b.options.scrollingX&&b.options.scrollingY)throw new Error("collectaui-repeat expected a parent x or y scrollView, not an xy scrollView.");var k=s.collectionRepeat,C=k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);if(!C)throw new Error("collectaui-repeat expected expression in form of '_item_ in _collection_[ track by _id_]' but got '"+s.collectionRepeat+"'.");var j,T=C[1],B=C[2],I=t(B),x={},A={},U={},V=[],E=s.itemRenderBuffer||s.collectionBufferSize,P=angular.isDefined(E)?parseInt(E):$,_=s.itemHeight||s.collectauiItemHeight,D=s.itemWidth||s.collectauiItemWidth,L=p(),R=f();v(),l.$element.on("scroll-resize",g),angular.element(n).on("resize",d);var M=a.$on("$atajoUiExposeAside",atajoui.animationFrameThrottle(function(){l.scrollView.resize(),d()}));r(g,0,!1),i.$watchCollection(I,function(e){if(V=e||(e=[]),!angular.isArray(e))throw new Error("collectaui-repeat expected an array for '"+B+"', but got a "+typeof value);i.$$postDigest(function(){h().setData(V),R.dataChangeRequiresRefresh(V)&&g()})}),i.$on("$destroy",function(){angular.element(n).off("resize",d),M(),l.$element&&l.$element.off("scroll-resize",g),N&&N.parentNode&&N.parentNode.removeChild(N),z&&z.$destroy(),z=N=null,j&&j.destroy(),j=null});var N,z}return{restrict:"A",priority:1e3,transclude:"element",$$tlb:!0,require:"^^$atajoUiScroll",link:o}}function t(e,t,n){var i={primaryPos:0,secondaryPos:0,primarySize:0,secondarySize:0,rowPrimarySize:0};return function(a){function r(){return o(!0)}function o(t){if(!o.destroyed){var n,a,r,c,u,d=ee.getScrollValue(),f=d+ee.scrollPrimarySize;ee.updateRenderRange(d,f),q=Math.max(0,q-j),F=Math.min(x.length-1,F+j);for(n in J)(q>n||n>F)&&(r=J[n],delete J[n],G.push(r),r.isShown=!1);for(n=q;F>=n;n++)n>=x.length||J[n]&&!t||(r=J[n]||(J[n]=G.length?G.pop():Y.length?Y.shift():new l),K.push(r),r.isShown=!0,u=r.scope,u.$index=n,u[C]=x[n],u.$first=0===n,u.$last=n===x.length-1,u.$middle=!(u.$first||u.$last),u.$odd=!(u.$even=0===(1&n)),u.$$disconnected&&atajoui.Utils.reconnectScope(r.scope),c=ee.getDimensions(n),(r.secondaryPos!==c.secondaryPos||r.primaryPos!==c.primaryPos)&&(r.node.style[atajoui.CSS.TRANSFORM]=N.replace(R,r.primaryPos=c.primaryPos).replace(M,r.secondaryPos=c.secondaryPos)),(r.secondarySize!==c.secondarySize||r.primarySize!==c.primarySize)&&(r.node.style.cssText=r.node.style.cssText.replace(m,z.replace(R,(r.primarySize=c.primarySize)+1).replace(M,r.secondarySize=c.secondarySize))));for(F===x.length-1&&(c=ee.getDimensions(x.length-1)||i,w.style[atajoui.CSS.TRANSFORM]=N.replace(R,c.primaryPos+c.primarySize).replace(M,0));G.length;)r=G.pop(),r.scope.$broadcast("$collectionRepeatLeave"),atajoui.Utils.disconnectScope(r.scope),Y.push(r),r.node.style[atajoui.CSS.TRANSFORM]="translate3d(-9999px,-9999px,0)",r.primaryPos=r.secondaryPos=null;if(y)for(n=0,a=K.length;a>n&&(r=K[n]);n++)if(r.images)for(var h,p=0,v=r.images.length;v>p&&(h=r.images[p]);p++){var $=h.src;h.src=g,h.src=$}if(t)for(var b=e.$$phase;K.length;)r=K.pop(),b||r.scope.$digest();else s()}}function s(){var t;s.running||(s.running=!0,n(function(){for(var n=e.$$phase;K.length;)t=K.pop(),t.isShown&&(n||t.scope.$digest());s.running=!1}))}function l(){var e=this;this.scope=T.$new(),this.id="item"+Z++,I(this.scope,function(t){e.element=t,e.element.data("$$collectionRepeatItem",e),e.node=t[0],e.node.style[atajoui.CSS.TRANSFORM]="translate3d(-9999px,-9999px,0)",e.node.style.cssText+=" height: 0px; width: 0px;",atajoui.Utils.disconnectScope(e.scope),b.appendChild(e.node),e.images=t[0].getElementsByTagName("img")})}function c(){this.getItemPrimarySize=V,this.getItemSecondarySize=P,this.getScrollValue=function(){return Math.max(0,Math.min(B.__scrollTop-O,B.__maxScrollTop-O-H))},this.refreshDirection=function(){this.scrollPrimarySize=B.__clientHeight,this.scrollSecondarySize=B.__clientWidth,this.estimatedPrimarySize=v,this.estimatedSecondarySize=$,this.estimatedItemsAcross=D&&Math.floor(B.__clientWidth/$)||1}}function u(){this.getItemPrimarySize=P,this.getItemSecondarySize=V,this.getScrollValue=function(){return Math.max(0,Math.min(B.__scrollLeft-O,B.__maxScrollLeft-O-H))},this.refreshDirection=function(){this.scrollPrimarySize=B.__clientWidth,this.scrollSecondarySize=B.__clientHeight,this.estimatedPrimarySize=$,this.estimatedSecondarySize=v,this.estimatedItemsAcross=D&&Math.floor(B.__clientHeight/v)||1}}function d(){this.getEstimatedSecondaryPos=function(e){return e%this.estimatedItemsAcross*this.estimatedSecondarySize},this.getEstimatedPrimaryPos=function(e){return Math.floor(e/this.estimatedItemsAcross)*this.estimatedPrimarySize},this.getEstimatedIndex=function(e){return Math.floor(e/this.estimatedPrimarySize)*this.estimatedItemsAcross}}function f(){this.getEstimatedSecondaryPos=function(){return 0},this.getEstimatedPrimaryPos=function(e){return e*this.estimatedPrimarySize},this.getEstimatedIndex=function(e){return Math.floor(e/this.estimatedPrimarySize)}}function h(){this.getContentSize=function(){return this.getEstimatedPrimaryPos(x.length-1)+this.estimatedPrimarySize+O+H};var e={};this.getDimensions=function(t){return e.primaryPos=this.getEstimatedPrimaryPos(t),e.secondaryPos=this.getEstimatedSecondaryPos(t),e.primarySize=this.estimatedPrimarySize,e.secondarySize=this.estimatedSecondarySize,e},this.updateRenderRange=function(e,t){q=Math.max(0,this.getEstimatedIndex(e)),F=Math.min(x.length-1,this.getEstimatedIndex(t)+this.estimatedItemsAcross-1),X=Math.max(0,this.getEstimatedPrimaryPos(q)),W=this.getEstimatedPrimaryPos(F)+this.estimatedPrimarySize}}function p(){function e(e){var t,r,o;for(t=Math.max(0,n);e>=t&&(o=s[t]);t++)r=s[t-1]||i,o.primarySize=a.getItemPrimarySize(t,x[t]),o.secondarySize=a.scrollSecondarySize,o.primaryPos=r.primaryPos+r.primarySize,o.secondaryPos=0}function t(e){var t,r,o;for(t=Math.max(n,0);e>=t&&(o=s[t]);t++)r=s[t-1]||i,o.secondarySize=Math.min(a.getItemSecondarySize(t,x[t]),a.scrollSecondarySize),o.secondaryPos=r.secondaryPos+r.secondarySize,0===t||o.secondaryPos+o.secondarySize>a.scrollSecondarySize?(o.secondaryPos=0,o.primarySize=a.getItemPrimarySize(t,x[t]),o.primaryPos=r.primaryPos+r.rowPrimarySize,o.rowStartIndex=t,o.rowPrimarySize=o.primarySize):(o.primarySize=a.getItemPrimarySize(t,x[t]),o.primaryPos=r.primaryPos,o.rowStartIndex=r.rowStartIndex,s[o.rowStartIndex].rowPrimarySize=o.rowPrimarySize=Math.max(s[o.rowStartIndex].rowPrimarySize,o.primarySize),o.rowPrimarySize=Math.max(o.primarySize,o.rowPrimarySize))}var n,a=this,r=atajoui.debounce(Q,25,!0),o=D?t:e,s=[];this.getContentSize=function(){var e=s[n]||i;return(e.primaryPos+e.primarySize||0)+this.getEstimatedPrimaryPos(x.length-n-1)+O+H},this.onDestroy=function(){s.length=0},this.onRefreshData=function(){var e,t;for(e=s.length,t=x.length;t>e;e++)s.push({});n=-1},this.onRefreshLayout=function(){n=-1},this.getDimensions=function(e){return e=Math.min(e,x.length-1),e>n&&(e>.9*x.length?(o(x.length-1),n=x.length-1,Q()):(o(e),n=e,r())),s[e]};var l=-1,c=-1;this.updateRenderRange=function(e,t){var n,i,a;if(this.getDimensions(2*this.getEstimatedIndex(t)),-1===l||0===e)n=0;else if(e>=c)for(n=l,i=x.length;i>n&&!((a=this.getDimensions(n))&&a.primaryPos+a.rowPrimarySize>=e);n++);else for(n=l;n>=0;n--)if((a=this.getDimensions(n))&&a.primaryPos<=e){n=D?a.rowStartIndex:n;break}q=Math.min(Math.max(0,n),x.length-1),X=-1!==q?this.getDimensions(q).primaryPos:-1;var r;for(n=q+1,i=x.length;i>n;n++)if((a=this.getDimensions(n))&&a.primaryPos+a.rowPrimarySize>t){if(D)for(r=a;i-1>n&&(a=this.getDimensions(n+1)).primaryPos===r.primaryPos;)n++;break}F=Math.min(n,x.length-1),W=-1!==F?(a=this.getDimensions(F)).primaryPos+(a.rowPrimarySize||a.primarySize):-1,c=e,l=q}}var v,$,w=a.afterItemsNode,b=a.containerNode,y=a.forceRefreshImages,S=a.heightData,k=a.widthData,C=a.keyExpression,j=a.renderBuffer,T=a.scope,B=a.scrollView,I=a.transclude,x=[],A={},U=S.getValue||function(){return S.value},V=function(e,t){return A[C]=t,A.$index=e,U(T,A)},E=k.getValue||function(){return k.value},P=function(e,t){return A[C]=t,A.$index=e,E(T,A)},_=!!B.options.scrollingY,D=_?k.dynamic||k.value!==B.__clientWidth:S.dynamic||S.value!==B.__clientHeight,L=!S.dynamic&&!k.dynamic,R="PRIMARY",M="SECONDARY",N=_?"translate3d(SECONDARYpx,PRIMARYpx,0)":"translate3d(PRIMARYpx,SECONDARYpx,0)",z=_?"height: PRIMARYpx; width: SECONDARYpx;":"height: SECONDARYpx; width: PRIMARYpx;",O=0,H=0,q=-1,F=-1,W=-1,X=-1,Y=[],G=[],K=[],J={},Z=0,Q=_?function(){B.setDimensions(null,null,null,ee.getContentSize(),!0)}:function(){B.setDimensions(null,null,ee.getContentSize(),null,!0)},ee=_?new c:new u;(D?d:f).call(ee),(L?h:p).call(ee);var te=_?"getContentHeight":"getContentWidth",ne=B.options[te];B.options[te]=angular.bind(ee,ee.getContentSize),B.__$callback=B.__callback,B.__callback=function(e,t,n,i){var a=ee.getScrollValue();(-1===q||a+ee.scrollPrimarySize>W||X>a)&&o(),B.__$callback(e,t,n,i)};var ie=!1,ae=!1;this.refreshLayout=function(){x.length?(v=V(0,x[0]),$=P(0,x[0])):(v=100,$=100);var e=getComputedStyle(w)||{},n=w.firstElementChild&&getComputedStyle(w.firstElementChild)||{},i=w.lastElementChild&&getComputedStyle(w.lastElementChild)||{};H=(parseInt(e[_?"height":"width"])||0)+(n&&parseInt(n[_?"marginTop":"marginLeft"])||0)+(i&&parseInt(i[_?"marginBottom":"marginRight"])||0),O=0;var a=b;do O+=a[_?"offsetTop":"offsetLeft"];while(atajoui.DomUtil.contains(B.__content,a=a.offsetParent));var o=b.previousElementSibling,s=o?t.getComputedStyle(o):{},c=parseInt(s[_?"marginBottom":"marginRight"]||0);if(b.style[atajoui.CSS.TRANSFORM]=N.replace(R,-c).replace(M,0),O-=c,B.__clientHeight&&B.__clientWidth||(B.__clientWidth=B.__container.clientWidth,B.__clientHeight=B.__container.clientHeight),(ee.onRefreshLayout||angular.noop)(),ee.refreshDirection(),Q(),!ie)for(var u=Math.max(20,3*j),d=0;u>d;d++)Y.push(new l);ie=!0,ie&&ae&&((B.__scrollLeft>B.__maxScrollLeft||B.__scrollTop>B.__maxScrollTop)&&B.resize(),r(!0))},this.setData=function(e){x=e,(ee.onRefreshData||angular.noop)(),ae=!0},this.destroy=function(){o.destroyed=!0,Y.forEach(function(e){e.scope.$destroy(),e.scope=e.element=e.node=e.images=null}),Y.length=K.length=G.length=0,J={},B.options[te]=ne,B.__callback=B.__$callback,B.resize(),(ee.onDestroy||angular.noop)()}}}function n(e){return["$atajoUiGesture","$parse",function(t,n){var i=e.substr(2).toLowerCase();return function(a,r,o){var s=n(o[e]),l=function(e){a.$apply(function(){s(a,{$event:e})})},c=t.on(i,l,r);a.$on("$destroy",function(){t.off(c,i,l)})}}]}function i(e){return["$document","$timeout",function(t,n){return{restrict:"E",controller:"$atajoUiHeaderBar",compile:function(i){function a(t,n,i,a){e?(t.$watch(function(){return n[0].className},function(e){var n=-1===e.indexOf("ng-hide"),i=-1!==e.indexOf("bar-subheader");t.$hasHeader=n&&!i,t.$hasSubheader=n&&i,t.$emit("$atajoUiSubheader",t.$hasSubheader)}),t.$on("$destroy",function(){delete t.$hasHeader,delete t.$hasSubheader}),a.align(),t.$on("$atajoUiHeader.align",function(){atajoui.requestAnimationFrame(function(){a.align()})})):(t.$watch(function(){return n[0].className},function(e){var n=-1===e.indexOf("ng-hide"),i=-1!==e.indexOf("bar-subfooter");t.$hasFooter=n&&!i,t.$hasSubfooter=n&&i}),t.$on("$destroy",function(){delete t.$hasFooter,delete t.$hasSubfooter}),t.$watch("$hasTabs",function(e){n.toggleClass("has-tabs",!!e)}),a.align(),t.$on("$atajoUiFooter.align",function(){atajoui.requestAnimationFrame(function(){a.align()})}))}return i.addClass(e?"bar bar-header":"bar bar-footer"),n(function(){e&&t[0].getElementsByClassName("tabs-top").length&&i.addClass("has-tabs-top")}),{pre:a}}}}]}function a(e){return e.clientHeight}function r(e){e.stopPropagation()}var o=angular.module("atajoui",["ngAnimate","ngSanitize","ui.router","ngIOS9UIWebViewPatch"]),s=angular.extend,l=angular.forEach,c=angular.isDefined,u=angular.isNumber,d=angular.isString,f=angular.element,h=angular.noop;o.factory("$atajoUiActionSheet",["$rootScope","$compile","$animate","$timeout","$atajoUiTemplateLoader","$atajoUiPlatform","$atajoUiBody","ATAJOUI_BACK_PRIORITY",function(e,t,n,i,a,r,o,l){function c(a){function c(e){e&&/icon/.test(e)&&(u.$actionSheetHasIcon=!0)}var u=e.$new(!0);s(u,{cancel:h,destructiveButtonClicked:h,buttonClicked:h,$deregisterBackButton:h,buttons:[],cancelOnStateChange:!0},a||{});for(var d=0;d<u.buttons.length;d++)c(u.buttons[d].text);c(u.cancelText),c(u.destructiveText);var p=u.element=t('<aui-actaui-sheet ng-class="cssClass" buttons="buttons"></aui-actaui-sheet>')(u),v=f(p[0].querySelector(".actaui-sheet-wrapper")),g=u.cancelOnStateChange?e.$on("$stateChangeSuccess",function(){u.cancel()}):h;return u.removeSheet=function(e){u.removed||(u.removed=!0,v.removeClass("actaui-sheet-up"),i(function(){o.removeClass("actaui-sheet-open")},400),u.$deregisterBackButton(),g(),n.removeClass(p,"active").then(function(){u.$destroy(),p.remove(),u.cancel.$scope=v=null,(e||h)(a.buttons)}))},u.showSheet=function(e){u.removed||(o.append(p).addClass("actaui-sheet-open"),n.addClass(p,"active").then(function(){u.removed||(e||h)()}),i(function(){u.removed||v.addClass("actaui-sheet-up")},20,!1))},u.$deregisterBackButton=r.registerBackButtonAction(function(){i(u.cancel)},l.actionSheet),u.cancel=function(){u.removeSheet(a.cancel)},u.buttonClicked=function(e){a.buttonClicked(e,a.buttons[e])===!0&&u.removeSheet()},u.destructiveButtonClicked=function(){a.destructiveButtonClicked()===!0&&u.removeSheet()},u.showSheet(),u.cancel.$scope=u,u.cancel}return{show:c}}]),f.prototype.addClass=function(e){var t,n,i,a,r,o;if(e&&"ng-scope"!=e&&"ng-isolate-scope"!=e)for(t=0;t<this.length;t++)if(a=this[t],a.setAttribute)if(e.indexOf(" ")<0&&a.classList.add)a.classList.add(e);else{for(o=(" "+(a.getAttribute("class")||"")+" ").replace(/[\n\t]/g," "),r=e.split(" "),n=0;n<r.length;n++)i=r[n].trim(),-1===o.indexOf(" "+i+" ")&&(o+=i+" ");a.setAttribute("class",o.trim())}return this},f.prototype.removeClass=function(e){var t,n,i,a,r;if(e)for(t=0;t<this.length;t++)if(r=this[t],r.getAttribute)if(e.indexOf(" ")<0&&r.classList.remove)r.classList.remove(e);else for(i=e.split(" "),n=0;n<i.length;n++)a=i[n],r.setAttribute("class",(" "+(r.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").replace(" "+a.trim()+" "," ").trim());return this},o.provider("$atajoUiConfig",function(){function e(e,i){o.platform[e]=i,a.platform[e]={},t(o,o.platform[e]),n(o.platform[e],a.platform[e],"")}function t(e,n){for(var i in e)i!=r&&e.hasOwnProperty(i)&&(angular.isObject(e[i])?(c(n[i])||(n[i]={}),t(e[i],n[i])):c(n[i])||(n[i]=null))}function n(e,t,a){l(e,function(s,l){angular.isObject(e[l])?(t[l]={},n(e[l],t[l],a+"."+l)):t[l]=function(n){if(arguments.length)return e[l]=n,t;if(e[l]==r){var s=i(o.platform,atajoui.Platform.platform()+a+"."+l);return s||s===!1?s:i(o.platform,"default"+a+"."+l)}return e[l]}})}function i(e,t){t=t.split(".");for(var n=0;n<t.length;n++){if(!e||!c(e[t[n]]))return null;e=e[t[n]]}return e}var a=this;a.platform={};var r="platform",o={views:{maxCache:r,forwardCache:r,transition:r,swipeBackEnabled:r,swipeBackHitWidth:r},navBar:{alignTitle:r,positionPrimaryButtons:r,positionSecondaryButtons:r,transition:r},backButton:{icon:r,text:r,previousTitleText:r},form:{checkbox:r,toggle:r},scrolling:{jsScrolling:r},spinner:{icon:r},tabs:{style:r,position:r},templates:{maxPrefetch:r},platform:{}};n(o,a,""),e("default",{views:{maxCache:10,forwardCache:!1,transition:"ios",swipeBackEnabled:!0,swipeBackHitWidth:45},navBar:{alignTitle:"center",positionPrimaryButtons:"left",positionSecondaryButtons:"right",transition:"view"},backButton:{icon:"ion-ios-arrow-back",text:"Back",previousTitleText:!0},form:{checkbox:"circle",toggle:"large"},scrolling:{jsScrolling:!0},spinner:{icon:"ios"},tabs:{style:"standard",position:"bottom"},templates:{maxPrefetch:30}}),e("ios",{}),e("android",{views:{transition:"android",swipeBackEnabled:!1},navBar:{alignTitle:"left",positionPrimaryButtons:"right",positionSecondaryButtons:"right"},backButton:{icon:"ion-android-arrow-back",text:!1,previousTitleText:!1},form:{checkbox:"square",toggle:"small"},spinner:{icon:"android"},tabs:{style:"striped",position:"top"},scrolling:{jsScrolling:!1}}),e("windowsphone",{spinner:{icon:"android"}}),a.transitions={views:{},navBar:{}},a.transitions.views.ios=function(e,t,n,i){function a(e,t,n,i){var a={};a[atajoui.CSS.TRANSITION_DURATION]=r.shouldAnimate?"":0,a.opacity=t,i>-1&&(a.boxShadow="0 0 10px rgba(0,0,0,"+(r.shouldAnimate?.45*i:.3)+")"),a[atajoui.CSS.TRANSFORM]="translate3d("+n+"%,0,0)",atajoui.DomUtil.cachedStyles(e,a)}var r={run:function(i){"forward"==n?(a(e,1,99*(1-i),1-i),a(t,1-.1*i,-33*i,-1)):"back"==n?(a(e,1-.1*(1-i),-33*(1-i),-1),a(t,1,100*i,1-i)):(a(e,1,0,-1),a(t,0,0,-1))},shouldAnimate:i&&("forward"==n||"back"==n)};return r},a.transitions.navBar.ios=function(e,t,n,i){function a(e,t,n,i){var a={};a[atajoui.CSS.TRANSITION_DURATION]=s.shouldAnimate?"":"0ms",a.opacity=1===t?"":t,e.setCss("buttons-left",a),e.setCss("buttons-right",a),e.setCss("back-button",a),a[atajoui.CSS.TRANSFORM]="translate3d("+i+"px,0,0)",e.setCss("back-text",a),a[atajoui.CSS.TRANSFORM]="translate3d("+n+"px,0,0)",e.setCss("title",a)}function r(e,t,n){if(e&&t){var i=(e.titleTextX()+e.titleWidth())*(1-n),r=t&&(t.titleTextX()-e.backButtonTextLeft())*(1-n)||0;a(e,n,i,r)}}function o(e,t,n){if(e&&t){var i=(-(e.titleTextX()-t.backButtonTextLeft())-e.titleLeftRight())*n;a(e,1-n,i,0)}}var s={run:function(n){var i=e.controller(),a=t&&t.controller();"back"==s.direction?(o(i,a,1-n),r(a,i,1-n)):(r(i,a,n),o(a,i,n))},direction:n,shouldAnimate:i&&("forward"==n||"back"==n)};return s},a.transitions.views.android=function(e,t,n,i){function a(e,t,n){var i={};i[atajoui.CSS.TRANSITION_DURATION]=r.shouldAnimate?"":0,i[atajoui.CSS.TRANSFORM]="translate3d("+t+"%,0,0)",i.opacity=n,atajoui.DomUtil.cachedStyles(e,i)}i=i&&("forward"==n||"back"==n);var r={run:function(i){"forward"==n?(a(e,99*(1-i),1),a(t,-100*i,1)):"back"==n?(a(e,-100*(1-i),1),a(t,100*i,1)):(a(e,0,1),a(t,0,0))},shouldAnimate:i};return r},a.transitions.navBar.android=function(e,t,n,i){function a(e,t){if(e){var n={};n.opacity=1===t?"":t,e.setCss("buttons-left",n),e.setCss("buttons-right",n),e.setCss("back-button",n),e.setCss("back-text",n),e.setCss("title",n)}}return{run:function(n){a(e.controller(),n),a(t&&t.controller(),1-n)},shouldAnimate:i&&("forward"==n||"back"==n)}},a.transitions.views.none=function(e,t){return{run:function(n){a.transitions.views.android(e,t,!1,!1).run(n)},shouldAnimate:!1}},a.transitions.navBar.none=function(e,t){return{run:function(n){a.transitions.navBar.ios(e,t,!1,!1).run(n),a.transitions.navBar.android(e,t,!1,!1).run(n)},shouldAnimate:!1}},a.setPlatformConfig=e,a.$get=function(){return a}}).config(["$compileProvider",function(e){e.aHrefSanitizationWhitelist(/^\s*(https?|sms|tel|geo|ftp|mailto|file|ghttps?|ms-appx-web|ms-appx|x-wmapp0):/),e.imgSrcSanitizationWhitelist(/^\s*(https?|ftp|file|content|blob|ms-appx|ms-appx-web|x-wmapp0):|data:image\//)}]),o.factory("$atajoUiBackdrop",["$document","$timeout","$$rAF","$rootScope",function(e,t,n,i){function a(){l++,1===l&&(s.addClass("visible"),i.$broadcast("backdrop.shown"),n(function(){l>=1&&s.addClass("active")}))}function r(){1===l&&(s.removeClass("active"),i.$broadcast("backdrop.hidden"),t(function(){0===l&&s.removeClass("visible")},400,!1)),l=Math.max(0,l-1)}function o(){return s}var s=f('<div class="backdrop">'),l=0;return e[0].body.appendChild(s[0]),{retain:a,release:r,getElement:o,_element:s}}]),o.factory("$atajoUiBind",["$parse","$interpolate",function(e,t){var n=/^\s*([@=&])(\??)\s*(\w*)\s*$/;return function(i,a,r){l(r||{},function(r,o){var s,l,c=r.match(n)||[],u=c[3]||o,d=c[1];switch(d){case"@":if(!a[u])return;a.$observe(u,function(e){i[o]=e}),a[u]&&(i[o]=t(a[u])(i));break;case"=":if(!a[u])return;l=i.$watch(a[u],function(e){i[o]=e}),i.$on("$destroy",l);break;case"&":if(a[u]&&a[u].match(RegExp(o+"(.*?)")))throw new Error('& expression binding "'+o+'" looks like it will recursively call "'+a[u]+'" and cause a stack overflow! Please choose a different scopeName.');s=e(a[u]),i[o]=function(e){return s(i,e)}}})}}]),o.factory("$atajoUiBody",["$document",function(e){return{addClass:function(){for(var t=0;t<arguments.length;t++)e[0].body.classList.add(arguments[t]);return this},removeClass:function(){for(var t=0;t<arguments.length;t++)e[0].body.classList.remove(arguments[t]);return this},enableClass:function(e){var t=Array.prototype.slice.call(arguments).slice(1);return e?this.addClass.apply(this,t):this.removeClass.apply(this,t),this},append:function(t){return e[0].body.appendChild(t.length?t[0]:t),this},get:function(){return e[0].body}}}]),o.factory("$atajoUiClickBlock",["$document","$atajoUiBody","$timeout",function(e,t,n){function i(e){e.preventDefault(),e.stopPropagation()}function a(){l&&(o?o.classList.remove(c):(o=e[0].createElement("div"),o.className="click-block",t.append(o),o.addEventListener("touchstart",i),o.addEventListener("mousedown",i)),l=!1)}function r(){o&&o.classList.add(c)}var o,s,l,c="click-block-hide";return{show:function(e){l=!0,n.cancel(s),s=n(this.hide,e||310,!1),a()},hide:function(){l=!1,n.cancel(s),r()}}}]),o.factory("$atajoUiGesture",[function(){return{on:function(e,t,n,i){return window.atajoui.onGesture(e,t,n[0],i)},off:function(e,t,n){return window.atajoui.offGesture(e,t,n)}}}]),o.factory("$atajoUiHistory",["$rootScope","$state","$location","$window","$timeout","$atajoUiViewSwitcher","$atajoUiNavViewDelegate",function(e,t,n,i,a,r,o){function l(e){return e?D.views[e]:null}function u(e){return e?l(e.backViewId):null}function d(e){return e?l(e.forwardViewId):null}function f(e){return e?D.histories[e]:null}function h(e){var t=p(e);return D.histories[t.historyId]||(D.histories[t.historyId]={historyId:t.historyId,parentHistoryId:p(t.scope.$parent).historyId,stack:[],cursor:-1}),f(t.historyId)}function p(t){for(var n=t;n;){if(n.hasOwnProperty("$historyId"))return{historyId:n.$historyId,scope:n};n=n.$parent}return{historyId:"root",scope:e}}function v(e){D.currentView=l(e),D.backView=u(D.currentView),D.forwardView=d(D.currentView)}function g(){var e;if(t&&t.current&&t.current.name){if(e=t.current.name,t.params)for(var n in t.params)t.params.hasOwnProperty(n)&&t.params[n]&&(e+="_"+n+"="+t.params[n]);return e}return atajoui.Utils.nextUid()}function m(){var e;if(t&&t.params)for(var n in t.params)t.params.hasOwnProperty(n)&&(e=e||{},e[n]=t.params[n]);return e}function $(e){return e&&e.length&&/aui-side-menus|aui-tabs/i.test(e[0].tagName)}function w(e,t){if(t&&t.$$state&&t.$$state.self.canSwipeBack===!1)return!1;if(e&&"false"===e.attr("can-swipe-back"))return!1;var n=e.find("aui-view");return n&&"false"===n.attr("can-swipe-back")?!1:!0}var b,y,S,k,C,j="initialView",T="newView",B="moveBack",I="moveForward",x="back",A="forward",U="enter",V="exit",E="swap",P="none",_=0,D={histories:{root:{historyId:"root",parentHistoryId:null,stack:[],cursor:-1}},views:{},backView:null,forwardView:null,currentView:null},L=function(){};return L.prototype.initialize=function(e){if(e){for(var t in e)this[t]=e[t];return this}return null},L.prototype.go=function(){if(this.stateName)return t.go(this.stateName,this.stateParams);if(this.url&&this.url!==n.url()){if(D.backView===this)return i.history.go(-1);if(D.forwardView===this)return i.history.go(1);n.url(this.url)}return null},L.prototype.destroy=function(){this.scope&&(this.scope.$destroy&&this.scope.$destroy(),this.scope=null)},{register:function(e,t){var i,o,s,c=g(),d=h(e),$=D.currentView,L=D.backView,R=D.forwardView,M=null,N=null,z=P,O=d.historyId,H=n.url();if(b!==c&&(b=c,_++),C)M=C.viewId,N=C.action,z=C.direction,C=null;else if(L&&L.stateId===c)M=L.viewId,O=L.historyId,N=B,L.historyId===$.historyId?z=x:$&&(z=V,i=f(L.historyId),i&&i.parentHistoryId===$.historyId?z=U:(i=f($.historyId),i&&i.parentHistoryId===d.parentHistoryId&&(z=E)));else if(R&&R.stateId===c)M=R.viewId,O=R.historyId,N=I,R.historyId===$.historyId?z=A:$&&(z=V,$.historyId===d.parentHistoryId?z=U:(i=f($.historyId),i&&i.parentHistoryId===d.parentHistoryId&&(z=E))),i=p(e),R.historyId&&i.scope&&(i.scope.$historyId=R.historyId,O=R.historyId);else if($&&$.historyId!==O&&d.cursor>-1&&d.stack.length>0&&d.cursor<d.stack.length&&d.stack[d.cursor].stateId===c){var q=d.stack[d.cursor];if(M=q.viewId,O=q.historyId,N=B,z=E,i=f($.historyId),i&&i.parentHistoryId===O?z=V:(i=f(O),i&&i.parentHistoryId===$.historyId&&(z=U)),i=l(q.backViewId),i&&q.historyId!==i.historyId){var F=Object.keys(D.views);F.forEach(function(e){var t=D.views[e];t.backViewId===q.viewId&&(t.backViewId=null)}),d.stack[d.cursor].backViewId=$.viewId}}else{if(s=r.createViewEle(t),this.isAbstractEle(s,t))return{action:"abstractView",direction:P,ele:s};if(M=atajoui.Utils.nextUid(),$){if($.forwardViewId=M,N=T,R&&$.stateId!==R.stateId&&$.historyId===R.historyId&&(i=f(R.historyId))){for(o=i.stack.length-1;o>=R.index;o--){var W=i.stack[o];W&&W.destroy&&W.destroy(),i.stack.splice(o)}O=R.historyId}d.historyId===$.historyId?z=A:$.historyId!==d.historyId&&(z=U,i=f($.historyId),i&&i.parentHistoryId===d.parentHistoryId?z=E:(i=f(i.parentHistoryId),i&&i.historyId===d.historyId&&(z=V)))}else N=j;2>_&&(z=P),D.views[M]=this.createView({viewId:M,index:d.stack.length,historyId:d.historyId,backViewId:$&&$.viewId?$.viewId:null,forwardViewId:null,stateId:c,stateName:this.currentStateName(),stateParams:m(),url:H,canSwipeBack:w(s,t)}),d.stack.push(D.views[M])}if(S&&S(),a.cancel(k),y){if(y.disableAnimate&&(z=P),y.disableBack&&(D.views[M].backViewId=null),y.historyRoot){for(o=0;o<d.stack.length;o++)d.stack[o].viewId===M?(d.stack[o].index=0,d.stack[o].backViewId=d.stack[o].forwardViewId=null):delete D.views[d.stack[o].viewId];d.stack=[D.views[M]]}y=null}if(v(M),D.backView&&O==D.backView.historyId&&c==D.backView.stateId&&H==D.backView.url)for(o=0;o<d.stack.length;o++)if(d.stack[o].viewId==M){N="dupNav",z=P,o>0&&(d.stack[o-1].forwardViewId=null),D.forwardView=null,D.currentView.index=D.backView.index,D.currentView.backViewId=D.backView.backViewId,D.backView=u(D.backView),d.stack.splice(o,1);break}return d.cursor=D.currentView.index,{viewId:M,action:N,direction:z,historyId:O,enableBack:this.enabledBack(D.currentView),isHistoryRoot:0===D.currentView.index,ele:s}},registerHistory:function(e){e.$historyId=atajoui.Utils.nextUid()},createView:function(e){var t=new L;return t.initialize(e)},getViewById:l,viewHistory:function(){return D},currentView:function(e){return arguments.length&&(D.currentView=e),D.currentView},currentHistoryId:function(){return D.currentView?D.currentView.historyId:null},currentTitle:function(e){return D.currentView?(arguments.length&&(D.currentView.title=e),D.currentView.title):void 0},backView:function(e){return arguments.length&&(D.backView=e),D.backView},backTitle:function(e){var t=e&&l(e.backViewId)||D.backView;return t&&t.title},forwardView:function(e){return arguments.length&&(D.forwardView=e),D.forwardView},currentStateName:function(){return t&&t.current?t.current.name:null},isCurrentStateNavView:function(e){return!!(t&&t.current&&t.current.views&&t.current.views[e])},goToHistoryRoot:function(e){if(e){var t=f(e);if(t&&t.stack.length){if(D.currentView&&D.currentView.viewId===t.stack[0].viewId)return;C={viewId:t.stack[0].viewId,action:B,direction:x},t.stack[0].go()}}},goBack:function(e){if(c(e)&&-1!==e){if(e>-1)return;var t=D.histories[this.currentHistoryId()],n=t.cursor+e+1;1>n&&(n=1),t.cursor=n,v(t.stack[n].viewId);for(var i=n-1,r=[],o=l(t.stack[i].forwardViewId);o&&(r.push(o.stateId||o.viewId),i++,!(i>=t.stack.length));)o=l(t.stack[i].forwardViewId);var s=this;r.length&&a(function(){s.clearCache(r)},300)}D.backView&&D.backView.go()},removeBackView:function(){var e=this,t=D.histories[this.currentHistoryId()],n=t.cursor,i=t.stack[n],a=t.stack[n-1],r=t.stack[n-2];a&&r&&(t.stack.splice(n-1,1),e.clearCache([a.viewId]),i.backViewId=r.viewId,i.index=i.index-1,r.forwardViewId=i.viewId,D.backView=r,t.currentCursor+=-1)},enabledBack:function(e){var t=u(e);return!(!t||t.historyId!==e.historyId)},clearHistory:function(){var e=D.histories,t=D.currentView;if(e)for(var n in e)e[n].stack&&(e[n].stack=[],e[n].cursor=-1),t&&t.historyId===n?(t.backViewId=t.forwardViewId=null,e[n].stack.push(t)):e[n].destroy&&e[n].destroy();for(var i in D.views)i!==t.viewId&&delete D.views[i];t&&v(t.viewId)},clearCache:function(e){return a(function(){o._instances.forEach(function(t){t.clearCache(e)})})},nextViewOptions:function(t){return S&&S(),arguments.length&&(a.cancel(k),null===t?y=t:(y=y||{},s(y,t),y.expire&&(S=e.$on("$stateChangeSuccess",function(){k=a(function(){y=null},y.expire)})))),y},isAbstractEle:function(e,t){return t&&t.$$state&&t.$$state.self["abstract"]?!0:!(!e||!$(e)&&!$(e.children()))},isActiveScope:function(e){if(!e)return!1;for(var t,n=e,i=this.currentHistoryId();n;){if(n.$$disconnected)return!1;if(!t&&n.hasOwnProperty("$historyId")&&(t=!0),i){if(n.hasOwnProperty("$historyId")&&i==n.$historyId)return!0;if(n.hasOwnProperty("$activeHistoryId")&&i==n.$activeHistoryId){if(n.hasOwnProperty("$historyId"))return!0;if(!t)return!0}}t&&n.hasOwnProperty("$activeHistoryId")&&(t=!1),n=n.$parent}return i?"root"==i:!0}}}]).run(["$rootScope","$state","$location","$document","$atajoUiPlatform","$atajoUiHistory","ATAJOUI_BACK_PRIORITY",function(e,t,n,i,a,r,o){
function s(e){var t=r.backView();return t?t.go():atajoui.Platform.exitApp(),e.preventDefault(),!1}e.$on("$atajoUiView.beforeEnter",function(){atajoui.keyboard&&atajoui.keyboard.hide&&atajoui.keyboard.hide()}),e.$on("$atajoUiHistory.change",function(e,i){if(!i)return null;var a=r.viewHistory(),o=i.historyId?a.histories[i.historyId]:null;if(o&&o.cursor>-1&&o.cursor<o.stack.length){var s=o.stack[o.cursor];return s.go(i)}!i.url&&i.uiSref&&(i.url=t.href(i.uiSref)),i.url&&(0===i.url.indexOf("#")&&(i.url=i.url.replace("#","")),i.url!==n.url()&&n.url(i.url))}),e.$atajoUiGoBack=function(e){r.goBack(e)},e.$on("$atajoUiView.afterEnter",function(e,t){t&&t.title&&(i[0].title=t.title)}),a.registerBackButtonAction(s,o.view)}]);var p='<div class="loading-container"><div class="loading"></div></div>';o.constant("$atajoUiLoadingConfig",{template:"<aui-spinner></aui-spinner>"}).factory("$atajoUiLoading",["$atajoUiLoadingConfig","$atajoUiBody","$atajoUiTemplateLoader","$atajoUiBackdrop","$timeout","$q","$log","$compile","$atajoUiPlatform","$rootScope","ATAJOUI_BACK_PRIORITY",function(e,t,n,i,a,r,o,l,c,u,d){function f(){return m||(m=n.compile({template:p,appendTo:t.get()}).then(function(e){return e.show=function(o){var s=o.templateUrl?n.load(o.templateUrl):r.when(o.template||o.content||"");e.scope=o.scope||e.scope,e.isShown||(e.hasBackdrop=!o.noBackdrop&&o.showBackdrop!==!1,e.hasBackdrop&&(i.retain(),i.getElement().addClass("backdrop-loading"))),o.duration&&(a.cancel(e.durationTimeout),e.durationTimeout=a(angular.bind(e,e.hide),+o.duration)),$(),$=c.registerBackButtonAction(h,d.loading),s.then(function(n){if(n){var i=e.element.children();i.html(n),l(i.contents())(e.scope)}e.isShown&&(e.element.addClass("visible"),atajoui.requestAnimationFrame(function(){e.isShown&&(e.element.addClass("active"),t.addClass("loading-active"))}))}),e.isShown=!0},e.hide=function(){$(),e.isShown&&(e.hasBackdrop&&(i.release(),i.getElement().removeClass("backdrop-loading")),e.element.removeClass("active"),t.removeClass("loading-active"),e.element.removeClass("visible"),atajoui.requestAnimationFrame(function(){!e.isShown&&e.element.removeClass("visible")})),a.cancel(e.durationTimeout),e.isShown=!1;var n=e.element.children();n.html("")},e})),m}function v(t){t=s({},e||{},t||{});var n=t.delay||t.showDelay||0;return w(),b(),t.hideOnStateChange&&(w=u.$on("$stateChangeSuccess",g),b=u.$on("$stateChangeError",g)),a.cancel(y),y=a(h,n),y.then(f).then(function(e){return e.show(t)})}function g(){return w(),b(),a.cancel(y),f().then(function(e){return e.hide()})}var m,$=h,w=h,b=h,y=r.when();return{show:v,hide:g,_getLoader:f}}]),o.factory("$atajoUiModal",["$rootScope","$atajoUiBody","$compile","$timeout","$atajoUiPlatform","$atajoUiTemplateLoader","$$q","$log","$atajoUiClickBlock","$window","ATAJOUI_BACK_PRIORITY",function(e,t,n,i,a,r,o,l,c,u,d){var p=atajoui.views.Modal.inherit({initialize:function(e){atajoui.views.Modal.prototype.initialize.call(this,e),this.animation=e.animation||"slide-in-up"},show:function(e){var n=this;if(n.scope.$$destroyed)return l.error("Cannot call "+n.viewType+".show() after remove(). Please create a new "+n.viewType+" instance."),o.when();c.show(600),m.add(n);var r=f(n.modalEl);n.el.classList.remove("hide"),i(function(){n._isShown&&t.addClass(n.viewType+"-open")},400,!1),n.el.parentElement||(r.addClass(n.animation),t.append(n.el));var s=r.data("$$atajoUiScrollController");return s&&s.resize(),e&&n.positauiView&&(n.positauiView(e,r),n._onWindowResize=function(){n._isShown&&n.positauiView(e,r)},atajoui.on("resize",n._onWindowResize,window)),r.addClass("ng-enter active").removeClass("ng-leave ng-leave-active"),n._isShown=!0,n._deregisterBackButton=a.registerBackButtonAction(n.hardwareBackButtonClose?angular.bind(n,n.hide):h,d.modal),atajoui.views.Modal.prototype.show.call(n),i(function(){n._isShown&&(r.addClass("ng-enter-active"),atajoui.trigger("resize"),n.scope.$parent&&n.scope.$parent.$broadcast(n.viewType+".shown",n),n.el.classList.add("active"),n.scope.$broadcast("$atajoUiHeader.align"),n.scope.$broadcast("$atajoUiFooter.align"),n.scope.$broadcast("$atajoui.modalPresented"))},20),i(function(){n._isShown&&(n.$el.on("touchmove",function(e){var t=atajoui.DomUtil.getParentOrSelfWithClass(e.target,"scroll");t||e.preventDefault()}),n.$el.on("click",function(e){n.backdropClickToClose&&e.target===n.el&&m.isHighest(n)&&n.hide()}))},400)},hide:function(){var e=this,n=f(e.modalEl);return c.show(600),m.remove(e),e.el.classList.remove("active"),n.addClass("ng-leave"),i(function(){e._isShown||(n.addClass("ng-leave-active").removeClass("ng-enter ng-enter-active active"),e.scope.$broadcast("$atajoui.modalRemoved"))},20,!1),e.$el.off("click"),e._isShown=!1,e.scope.$parent&&e.scope.$parent.$broadcast(e.viewType+".hidden",e),e._deregisterBackButton&&e._deregisterBackButton(),atajoui.views.Modal.prototype.hide.call(e),e.positauiView&&atajoui.off("resize",e._onWindowResize,window),i(function(){t.removeClass(e.viewType+"-open"),e.el.classList.add("hide")},e.hideDelay||320)},remove:function(){var e,t,n=this;return n.scope.$parent&&n.scope.$parent.$broadcast(n.viewType+".removed",n),n._isShown?t=n.hide():(e=o.defer(),e.resolve(),t=e.promise),t.then(function(){n.scope.$destroy(),n.$el.remove()})},isShown:function(){return!!this._isShown}}),v=function(t,i){var a=i.scope&&i.scope.$new()||e.$new(!0);i.viewType=i.viewType||"modal",s(a,{$hasHeader:!1,$hasSubheader:!1,$hasFooter:!1,$hasSubfooter:!1,$hasTabs:!1,$hasTabsTop:!1});var r=n("<aui-"+i.viewType+">"+t+"</aui-"+i.viewType+">")(a);i.$el=r,i.el=r[0],i.modalEl=i.el.querySelector("."+i.viewType);var o=new p(i);return o.scope=a,i.scope||(a[i.viewType]=o),o},g=[],m={add:function(e){g.push(e)},remove:function(e){var t=g.indexOf(e);t>-1&&t<g.length&&g.splice(t,1)},isHighest:function(e){var t=g.indexOf(e);return t>-1&&t===g.length-1}};return{fromTemplate:function(e,t){var n=v(e,t||{});return n},fromTemplateUrl:function(e,t,n){var i;return angular.isFunction(t)&&(i=t,t=n),r.load(e).then(function(e){var n=v(e,t||{});return i&&i(n),n})},stack:m}}]),o.service("$atajoUiNavBarDelegate",atajoui.DelegateService(["align","showBackButton","showBar","title","changeTitle","setTitle","getTitle","back","getPreviousTitle"])),o.service("$atajoUiNavViewDelegate",atajoui.DelegateService(["clearCache"])),o.constant("ATAJOUI_BACK_PRIORITY",{view:100,sideMenu:150,modal:200,actionSheet:300,popup:400,loading:500}).provider("$atajoUiPlatform",function(){return{$get:["$q","$atajoUiScrollDelegate",function(e,t){var n={onHardwareBackButton:function(e){atajoui.Platform.ready(function(){document.addEventListener("backbutton",e,!1)})},offHardwareBackButton:function(e){atajoui.Platform.ready(function(){document.removeEventListener("backbutton",e)})},$backButtonActions:{},registerBackButtonAction:function(e,t,i){n._hasBackButtonHandler||(n.$backButtonActions={},n.onHardwareBackButton(n.hardwareBackButtonClick),n._hasBackButtonHandler=!0);var a={id:i?i:atajoui.Utils.nextUid(),priority:t?t:0,fn:e};return n.$backButtonActions[a.id]=a,function(){delete n.$backButtonActions[a.id]}},hardwareBackButtonClick:function(e){var t,i;for(i in n.$backButtonActions)(!t||n.$backButtonActions[i].priority>=t.priority)&&(t=n.$backButtonActions[i]);return t?(t.fn(e),t):void 0},is:function(e){return atajoui.Platform.is(e)},on:function(e,t){return atajoui.Platform.ready(function(){document.addEventListener(e,t,!1)}),function(){atajoui.Platform.ready(function(){document.removeEventListener(e,t)})}},ready:function(n){var i=e.defer();return atajoui.Platform.ready(function(){window.addEventListener("statusTap",function(){t.scrollTop(!0)}),i.resolve(),n&&n()}),i.promise}};return n}]}}),o.factory("$atajoUiPopover",["$atajoUiModal","$atajoUiPosition","$document","$window",function(e,t,n,i){function a(e,n){var a=f(e.target||e),o=t.offset(a),s=n.prop("offsetWidth"),l=n.prop("offsetHeight"),c=i.innerWidth,u=i.innerHeight,d={left:o.left+o.width/2-s/2},h=f(n[0].querySelector(".popover-arrow"));d.left<r?d.left=r:d.left+s+r>c&&(d.left=c-s-r),o.top+o.height+l>u&&o.top-l>0?(d.top=o.top-l,n.addClass("popover-bottom")):(d.top=o.top+o.height,n.removeClass("popover-bottom")),h.css({left:o.left+o.width/2-h.prop("offsetWidth")/2-d.left+"px"}),n.css({top:d.top+"px",left:d.left+"px",marginLeft:"0",opacity:"1"})}var r=6,o={viewType:"popover",hideDelay:1,animation:"none",positauiView:a};return{fromTemplate:function(t,n){return e.fromTemplate(t,atajoui.Utils.extend({},o,n))},fromTemplateUrl:function(t,n){return e.fromTemplateUrl(t,atajoui.Utils.extend({},o,n))}}}]);var v='<div class="popup-container" ng-class="cssClass"><div class="popup"><div class="popup-head"><h3 class="popup-title" ng-bind-html="title"></h3><h5 class="popup-sub-title" ng-bind-html="subTitle" ng-if="subTitle"></h5></div><div class="popup-body"></div><div class="popup-buttons" ng-show="buttons.length"><button ng-repeat="button in buttons" ng-click="$buttonTapped(button, $event)" class="button" ng-class="button.type || \'button-default\'" ng-bind-html="button.text"></button></div></div></div>';o.factory("$atajoUiPopup",["$atajoUiTemplateLoader","$atajoUiBackdrop","$q","$timeout","$rootScope","$atajoUiBody","$compile","$atajoUiPlatform","$atajoUiModal","ATAJOUI_BACK_PRIORITY",function(e,t,n,i,a,r,o,l,c,u){function d(t){t=s({scope:null,title:"",buttons:[]},t||{});var l={};return l.scope=(t.scope||a).$new(),l.element=f(v),l.responseDeferred=n.defer(),r.get().appendChild(l.element[0]),o(l.element)(l.scope),s(l.scope,{title:t.title,buttons:t.buttons,subTitle:t.subTitle,cssClass:t.cssClass,$buttonTapped:function(e,t){var n=(e.onTap||h).apply(l,[t]);t=t.originalEvent||t,t.defaultPrevented||l.responseDeferred.resolve(n)}}),n.when(t.templateUrl?e.load(t.templateUrl):t.template||t.content||"").then(function(e){var t=f(l.element[0].querySelector(".popup-body"));e?(t.html(e),o(t.contents())(l.scope)):t.remove()}),l.show=function(){l.isShown||l.removed||(c.stack.add(l),l.isShown=!0,atajoui.requestAnimationFrame(function(){l.isShown&&(l.element.removeClass("popup-hidden"),l.element.addClass("popup-showing active"),m(l.element))}))},l.hide=function(e){return e=e||h,l.isShown?(c.stack.remove(l),l.isShown=!1,l.element.removeClass("active"),l.element.addClass("popup-hidden"),void i(e,250,!1)):e()},l.remove=function(){l.removed||(l.hide(function(){l.element.remove(),l.scope.$destroy()}),l.removed=!0)},l}function p(){var e=S[S.length-1];e&&e.responseDeferred.resolve()}function g(e){function n(){S.push(a),i(a.show,o,!1),a.responseDeferred.promise.then(function(e){var n=S.indexOf(a);return-1!==n&&S.splice(n,1),a.remove(),S.length>0?S[S.length-1].show():(t.release(),i(function(){S.length||r.removeClass("popup-open")},400,!1),(k._backButtonActionDone||h)()),e})}var a=k._createPopup(e),o=0;return S.length>0?(o=y.stackPushDelay,i(S[S.length-1].hide,o,!1)):(r.addClass("popup-open"),t.retain(),k._backButtonActionDone=l.registerBackButtonAction(p,u.popup)),a.responseDeferred.promise.close=function(e){a.removed||a.responseDeferred.resolve(e)},a.responseDeferred.notify({close:a.responseDeferred.close}),n(),a.responseDeferred.promise}function m(e){var t=e[0].querySelector("[autofocus]");t&&t.focus()}function $(e){return g(s({buttons:[{text:e.okText||"OK",type:e.okType||"button-positive",onTap:function(){return!0}}]},e||{}))}function w(e){return g(s({buttons:[{text:e.cancelText||"Cancel",type:e.cancelType||"button-default",onTap:function(){return!1}},{text:e.okText||"OK",type:e.okType||"button-positive",onTap:function(){return!0}}]},e||{}))}function b(e){var t=a.$new(!0);t.data={},t.data.fieldtype=e.inputType?e.inputType:"text",t.data.response=e.defaultText?e.defaultText:"",t.data.placeholder=e.inputPlaceholder?e.inputPlaceholder:"",t.data.maxlength=e.maxLength?parseInt(e.maxLength):"";var n="";return e.template&&/<[a-z][\s\S]*>/i.test(e.template)===!1&&(n="<span>"+e.template+"</span>",delete e.template),g(s({template:n+'<input ng-model="data.response" type="{{ data.fieldtype }}"maxlength="{{ data.maxlength }}"placeholder="{{ data.placeholder }}">',scope:t,buttons:[{text:e.cancelText||"Cancel",type:e.cancelType||"button-default",onTap:function(){}},{text:e.okText||"OK",type:e.okType||"button-positive",onTap:function(){return t.data.response||""}}]},e||{}))}var y={stackPushDelay:75},S=[],k={show:g,alert:$,confirm:w,prompt:b,_createPopup:d,_popupStack:S};return k}]),o.factory("$atajoUiPosition",["$document","$window",function(e,t){function n(e,n){return e.currentStyle?e.currentStyle[n]:t.getComputedStyle?t.getComputedStyle(e)[n]:e.style[n]}function i(e){return"static"===(n(e,"position")||"static")}var a=function(t){for(var n=e[0],a=t.offsetParent||n;a&&a!==n&&i(a);)a=a.offsetParent;return a||n};return{position:function(t){var n=this.offset(t),i={top:0,left:0},r=a(t[0]);r!=e[0]&&(i=this.offset(f(r)),i.top+=r.clientTop-r.scrollTop,i.left+=r.clientLeft-r.scrollLeft);var o=t[0].getBoundingClientRect();return{width:o.width||t.prop("offsetWidth"),height:o.height||t.prop("offsetHeight"),top:n.top-i.top,left:n.left-i.left}},offset:function(n){var i=n[0].getBoundingClientRect();return{width:i.width||n.prop("offsetWidth"),height:i.height||n.prop("offsetHeight"),top:i.top+(t.pageYOffset||e[0].documentElement.scrollTop),left:i.left+(t.pageXOffset||e[0].documentElement.scrollLeft)}}}}]),o.service("$atajoUiScrollDelegate",atajoui.DelegateService(["resize","scrollTop","scrollBottom","scrollTo","scrollBy","zoomTo","zoomBy","getScrollPosition","anchorScroll","freezeScroll","freezeAllScrolls","getScrollView"])),o.service("$atajoUiSideMenuDelegate",atajoui.DelegateService(["toggleLeft","toggleRight","getOpenRatio","isOpen","isOpenLeft","isOpenRight","canDragContent","edgeDragThreshold"])),o.service("$atajoUiSlideBoxDelegate",atajoui.DelegateService(["update","slide","select","enableSlide","previous","next","stop","autoPlay","start","currentIndex","selected","slidesCount","count","loop"])),o.service("$atajoUiTabsDelegate",atajoui.DelegateService(["select","selectedIndex","showBar"])),function(){var e=[];o.factory("$atajoUiTemplateCache",["$http","$templateCache","$timeout",function(t,n,i){function a(e){return"undefined"==typeof e?r():(d(e)&&(e=[e]),l(e,function(e){s.push(e)}),void(o&&r()))}function r(){var e;if(a._runCount++,o=!0,0!==s.length){for(var l=0;4>l&&(e=s.pop());)d(e)&&t.get(e,{cache:n}),l++;s.length&&i(r,1e3)}}var o,s=e;return a._runCount=0,a}]).config(["$stateProvider","$atajoUiConfigProvider",function(t,n){var i=t.state;t.state=function(a,r){if("object"==typeof r){var o=r.prefetchTemplate!==!1&&e.length<n.templates.maxPrefetch();if(o&&d(r.templateUrl)&&e.push(r.templateUrl),angular.isObject(r.views))for(var s in r.views)o=r.views[s].prefetchTemplate!==!1&&e.length<n.templates.maxPrefetch(),o&&d(r.views[s].templateUrl)&&e.push(r.views[s].templateUrl)}return i.call(t,a,r)}}]).run(["$atajoUiTemplateCache",function(e){e()}])}(),o.factory("$atajoUiTemplateLoader",["$compile","$controller","$http","$q","$rootScope","$templateCache",function(e,t,n,i,a,r){function o(e){return n.get(e,{cache:r}).then(function(e){return e.data&&e.data.trim()})}function l(n){n=s({template:"",templateUrl:"",scope:null,controller:null,locals:{},appendTo:null},n||{});var r=n.templateUrl?this.load(n.templateUrl):i.when(n.template);return r.then(function(i){var r,o=n.scope||a.$new(),l=f("<div>").html(i).contents();return n.controller&&(r=t(n.controller,s(n.locals,{$scope:o})),l.children().data("$ngControllerController",r)),n.appendTo&&f(n.appendTo).append(l),e(l)(o),{element:l,scope:o}})}return{load:o,compile:l}}]),o.factory("$atajoUiViewService",["$atajoUiHistory","$log",function(e,t){function n(e,n){t.warn("$atajoUiViewService"+e+" is deprecated, please use $atajoUiHistory"+n+" instead: http://ionicframework.com/docs/nightly/api/service/$atajoUiHistory/")}n("","");var i={getCurrentView:"currentView",getBackView:"backView",getForwardView:"forwardView",getCurrentStateName:"currentStateName",nextViewOptions:"nextViewOptions",clearHistory:"clearHistory"};return l(i,function(t,a){i[a]=function(){return n("."+a,"."+t),e[t].apply(this,arguments)}}),i}]),o.factory("$atajoUiViewSwitcher",["$timeout","$document","$q","$atajoUiClickBlock","$atajoUiConfig","$atajoUiNavBarDelegate",function(e,t,n,i,a,r){function o(e,t){return u(e)["abstract"]?u(e).name:t?t.stateId||t.viewId:atajoui.Utils.nextUid()}function u(e){return e&&e.$$state&&e.$$state.self||{}}function d(e,t,n,i){var r=u(e),o=w||P(t,"view-transition")||r.viewTransition||a.views.transition()||"ios",l=a.navBar.transition();return n=b||P(t,"view-direction")||r.viewDirection||n||"none",s(h(i),{transition:o,navBarTransition:"view"===l?o:l,direction:n,shouldAnimate:"none"!==o&&"none"!==n})}function h(e){return e=e||{},{viewId:e.viewId,historyId:e.historyId,stateId:e.stateId,stateName:e.stateName,stateParams:e.stateParams}}function p(e,t){return arguments.length>1?void P(e,I,t):P(e,I)}function v(e){if(e&&e.length){var t=e.scope();t&&(t.$emit("$atajoUiView.unloaded",e.data(B)),t.$destroy()),e.remove()}}function g(e,t){var n=e.lastIndexOf("."),i=t.lastIndexOf(".");if(0>n||0>i)return!1;var a=e.substring(0,n),r=t.substring(0,i);return a===r}function m(e,t){if(!e)return null;var n=angular.element(e).attr("abstract"),i=angular.element(e).attr("state");if("true"!==n)return i===t.stateName?angular.element(e).scope():null;for(var a=$(e),r=0;r<a.length;r++){var o=angular.element(a[r]).attr("state");if(o===t.stateName)return t.abstractView=!0,angular.element(a[r]).scope()}return null}function $(e){for(var t=[],n=angular.element(e).find("aui-nav-view"),i=0;i<n.length;i++){for(var a=angular.element(n[i]).children(),r=[],o=0;o<a.length;o++)r=r.concat(a[o]);t=t.concat(r)}return t}var w,b,y="webkitTransitionEnd transitionend",S="$noCache",k="$destroyEle",C="$eleId",j="$accessed",T="$fallbackTimer",B="$viewData",I="nav-view",x="active",A="cached",U="stage",V=0;atajoui.transition=atajoui.transition||{},atajoui.transition.isActive=!1;var E,P=atajoui.DomUtil.cachedAttr,_=[],D=1100,L={create:function(t,l,f,$,I,E){var R,M,N,z=++V,O={init:function(e,t){L.isTransitioning(!0),O.loadViewElements(e),O.render(e,function(){t&&t()})},loadViewElements:function(e){var n,i,a,r=t.getViewElements(),s=o(l,f),u=t.activeEleId();for(n=0,i=r.length;i>n&&(a=r.eq(n),a.data(C)===s?a.data(S)?(a.data(C,s+atajoui.Utils.nextUid()),a.data(k,!0)):R=a:c(u)&&a.data(C)===u&&(M=a),!R||!M);n++);N=!!R,N||(R=e.ele||L.createViewEle(l),R.data(C,s)),E&&t.activeEleId(s),e.ele=null},render:function(e,n){if(N)atajoui.Utils.reconnectScope(R.scope());else{p(R,U);var i=d(l,R,e.direction,f),r=a.transitions.views[i.transition]||a.transitions.views.none;r(R,null,i.direction,!0).run(0),R.data(B,{viewId:i.viewId,historyId:i.historyId,stateName:i.stateName,stateParams:i.stateParams}),(u(l).cache===!1||"false"===u(l).cache||"false"==R.attr("cache-view")||0===a.views.maxCache())&&R.data(S,!0);var o=t.appendViewElement(R,l);delete i.direction,delete i.transition,o.$emit("$atajoUiView.loaded",i)}R.data(j,Date.now()),n&&n()},transition:function(o,c,u){function v(){p(R,q.shouldAnimate?"entering":x),p(M,q.shouldAnimate?"leaving":A),q.run(1),r._instances.forEach(function(e){e.triggerTransitionStart(z)}),q.shouldAnimate||m()}function g(e){e.target===this&&m()}function m(){m.x||(m.x=!0,R.off(y,g),e.cancel(R.data(T)),M&&e.cancel(M.data(T)),C&&C.resolve(t),z===V&&(n.all(_).then(L.transitionEnd),O.emit("after",j,B),O.cleanup(j)),r._instances.forEach(function(e){e.triggerTransitionEnd()}),w=b=f=$=R=M=null)}function S(e){e.target===this&&k()}function k(){p(R,A),p(M,x),R.off(y,S),e.cancel(R.data(T)),L.transitionEnd([t])}var C,j=d(l,R,o,f),B=s(s({},j),h($));j.transitionId=B.transitionId=z,j.fromCache=!!N,j.enableBack=!!c,j.renderStart=I,j.renderEnd=E,P(R.parent(),"nav-view-transition",j.transition),P(R.parent(),"nav-view-direction",j.direction),e.cancel(R.data(T));var H=a.transitions.views[j.transition]||a.transitions.views.none,q=H(R,M,j.direction,j.shouldAnimate&&u&&E);if(q.shouldAnimate&&(R.on(y,g),R.data(T,e(m,D)),i.show(D)),I&&(O.emit("before",j,B),p(R,U),q.run(0)),E&&(C=n.defer(),_.push(C.promise)),I&&E)e(function(){atajoui.requestAnimationFrame(v)});else{if(!E)return p(R,"entering"),p(M,"leaving"),{run:q.run,cancel:function(t){t?(R.on(y,S),R.data(T,e(k,D)),i.show(D)):k(),q.shouldAnimate=t,q.run(0),q=null}};E&&v()}},emit:function(e,t,n){var i,a=m(R,t),r=m(M,n);!t.viewId||t.abstractView?r&&(r.$emit("$atajoUiView.beforeLeave",n),r.$emit("$atajoUiView.leave",n),r.$emit("$atajoUiView.afterLeave",n),r.$broadcast("$atajoUiParentView.beforeLeave",n),r.$broadcast("$atajoUiParentView.leave",n),r.$broadcast("$atajoUiParentView.afterLeave",n)):("after"==e&&(a&&(a.$emit("$atajoUiView.enter",t),a.$broadcast("$atajoUiParentView.enter",t)),r?(r.$emit("$atajoUiView.leave",n),r.$broadcast("$atajoUiParentView.leave",n)):a&&n&&n.viewId&&t.stateName!==n.stateName&&(i=g(t.stateName,n.stateName),i&&a.$emit("$atajoUiNavView.leave",n))),a&&(a.$emit("$atajoUiView."+e+"Enter",t),a.$broadcast("$atajoUiParentView."+e+"Enter",t)),r?(r.$emit("$atajoUiView."+e+"Leave",n),r.$broadcast("$atajoUiParentView."+e+"Leave",n)):a&&n&&n.viewId&&t.stateName!==n.stateName&&(i=g(t.stateName,n.stateName),i&&a.$emit("$atajoUiNavView."+e+"Leave",n)))},cleanup:function(e){M&&"back"==e.direction&&!a.views.forwardCache()&&v(M);var n,i,r,o=t.getViewElements(),s=o.length,l=s-1>a.views.maxCache(),c=Date.now();for(n=0;s>n;n++)i=o.eq(n),l&&i.data(j)<c?(c=i.data(j),r=o.eq(n)):i.data(k)&&p(i)!=x&&v(i);v(r),R.data(S)&&R.data(k,!0)},enteringEle:function(){return R},leavingEle:function(){return M}};return O},transitionEnd:function(e){l(e,function(e){e.transitionEnd()}),L.isTransitioning(!1),i.hide(),_=[]},nextTransition:function(e){w=e},nextDirection:function(e){b=e},isTransitioning:function(t){return arguments.length&&(atajoui.transition.isActive=!!t,e.cancel(E),t&&(E=e(function(){L.isTransitioning(!1)},999))),atajoui.transition.isActive},createViewEle:function(e){var n=t[0].createElement("div");return e&&e.$template&&(n.innerHTML=e.$template,1===n.children.length)?(n.children[0].classList.add("pane"),e.$$state&&e.$$state.self&&e.$$state.self["abstract"]?angular.element(n.children[0]).attr("abstract","true"):e.$$state&&e.$$state.self&&angular.element(n.children[0]).attr("state",e.$$state.self.name),f(n.children[0])):(n.className="pane",f(n))},viewEleIsActive:function(e,t){p(e,t?x:A)},getTransitionData:d,navViewAttr:p,destroyViewEle:v};return L}]),angular.module("ngIOS9UIWebViewPatch",["ng"]).config(["$provide",function(e){"use strict";e.decorator("$browser",["$delegate","$window",function(e,t){function n(e){return/(iPhone|iPad|iPod).* OS 9_\d/.test(e)&&!/Version\/9\./.test(e)}function i(e){function t(){n=null}var n=null,i=e.url;return e.url=function(){return arguments.length?(n=arguments[0],i.apply(e,arguments)):n||i.apply(e,arguments)},window.addEventListener("popstate",t,!1),window.addEventListener("hashchange",t,!1),e}return n(t.navigator.userAgent)?i(e):e}])}]),o.config(["$provide",function(e){e.decorator("$compile",["$delegate",function(e){return e.$$addScopeInfo=function(e,t,n,i){var a=n?i?"$isolateScopeNoTemplate":"$isolateScope":"$scope";e.data(a,t)},e}])}]),o.config(["$provide",function(e){function t(e,t){return e.__hash=e.hash,e.hash=function(n){return c(n)&&n.length>0&&t(function(){var e=document.querySelector(".scroll-content");e&&(e.scrollTop=0)},0,!1),e.__hash(n)},e}e.decorator("$location",["$delegate","$timeout",t])}]),o.controller("$atajoUiHeaderBar",["$scope","$element","$attrs","$q","$atajoUiConfig","$atajoUiHistory",function(e,t,n,i,a,r){function o(e){return C[e]||(C[e]=t[0].querySelector("."+e)),C[e]}var s="title",l="back-text",c="back-button",u="default-title",d="previous-title",f="hide",h=this,p="",v="",g=0,m=0,$="",w=!1,b=!0,y=!0,S=!1,k=0;h.beforeEnter=function(t){e.$broadcast("$atajoUiView.beforeEnter",t)},h.title=function(e){return arguments.length&&e!==p&&(o(s).innerHTML=e,p=e,k=0),p},h.enableBack=function(e,t){return arguments.length&&(w=e,t||h.updateBackButton()),w},h.showBack=function(e,t){return arguments.length&&(b=e,t||h.updateBackButton()),b},h.showNavBack=function(e){y=e,h.updateBackButton()},h.updateBackButton=function(){var e;(b&&y&&w)!==S&&(S=b&&y&&w,e=o(c),e&&e.classList[S?"remove":"add"](f)),w&&(e=e||o(c),e&&(h.backButtonIcon!==a.backButton.icon()&&(e=o(c+" .icon"),e&&(h.backButtonIcon=a.backButton.icon(),e.className="icon "+h.backButtonIcon)),h.backButtonText!==a.backButton.text()&&(e=o(c+" .back-text"),e&&(e.textContent=h.backButtonText=a.backButton.text()))))},h.titleTextWidth=function(){var e=o(s);if(e)for(var t=angular.element(e).children(),n=0;n<t.length;n++)if(angular.element(t[n]).hasClass("nav-bar-title")){e=t[n];break}var i=atajoui.DomUtil.getTextBounds(e);return k=Math.min(i&&i.width||30)},h.titleWidth=function(){var e=h.titleTextWidth(),t=o(s).offsetWidth;return e>t&&(e=t+(g-m-5)),e},h.titleTextX=function(){return t[0].offsetWidth/2-h.titleWidth()/2},h.titleLeftRight=function(){return g-m},h.backButtonTextLeft=function(){for(var e=0,t=o(l);t;)e+=t.offsetLeft,t=t.parentElement;return e},h.resetBackButton=function(e){if(a.backButton.previousTitleText()){var t=o(d);if(t){t.classList.remove(f);var n=e&&r.getViewById(e.viewId),i=r.backTitle(n);i!==v&&(v=t.innerHTML=i)}var s=o(u);s&&s.classList.remove(f)}},h.align=function(e){var i=o(s);e=e||n.alignTitle||a.navBar.alignTitle();var r=h.calcWidths(e,!1);if(b&&v&&a.backButton.previousTitleText()){var l=h.calcWidths(e,!0),c=t[0].offsetWidth-l.titleLeft-l.titleRight;h.titleTextWidth()<=c&&(r=l)}return h.updatePositions(i,r.titleLeft,r.titleRight,r.buttonsLeft,r.buttonsRight,r.css,r.showPrevTitle)},h.calcWidths=function(e,n){var i,a,r,h,p,v,g,m,$,w=o(s),y=o(c),S=t[0].childNodes,k=0,C=0,j=0,T=0,B="",I=0;for(i=0;i<S.length;i++){if(p=S[i],g=0,1==p.nodeType){if(p===w){$=!0;continue}if(p.classList.contains(f))continue;if(b&&p===y){for(a=0;a<p.childNodes.length;a++)if(h=p.childNodes[a],1==h.nodeType)if(h.classList.contains(l))for(r=0;r<h.children.length;r++)if(v=h.children[r],n){if(v.classList.contains(u))continue;I+=v.offsetWidth}else{if(v.classList.contains(d))continue;I+=v.offsetWidth}else I+=h.offsetWidth;else 3==h.nodeType&&h.nodeValue.trim()&&(m=atajoui.DomUtil.getTextBounds(h),I+=m&&m.width||0);g=I||p.offsetWidth}else g=p.offsetWidth}else 3==p.nodeType&&p.nodeValue.trim()&&(m=atajoui.DomUtil.getTextBounds(p),g=m&&m.width||0);$?C+=g:k+=g}if("left"==e)B="title-left",k&&(j=k+15),C&&(T=C+15);else if("right"==e)B="title-right",k&&(j=k+15),C&&(T=C+15);else{var x=Math.max(k,C)+10;x>10&&(j=T=x)}return{backButtonWidth:I,buttonsLeft:k,buttonsRight:C,titleLeft:j,titleRight:T,showPrevTitle:n,css:B}},h.updatePositions=function(e,n,r,s,l,c,p){var v=i.defer();if(e&&(n!==g&&(e.style.left=n?n+"px":"",g=n),r!==m&&(e.style.right=r?r+"px":"",m=r),c!==$&&(c&&e.classList.add(c),$&&e.classList.remove($),$=c)),a.backButton.previousTitleText()){var w=o(d),b=o(u);w&&w.classList[p?"remove":"add"](f),b&&b.classList[p?"add":"remove"](f)}return atajoui.requestAnimationFrame(function(){if(e&&e.offsetWidth+10<e.scrollWidth){var n=l+5,i=t[0].offsetWidth-g-h.titleTextWidth()-20;r=n>i?n:i,r!==m&&(e.style.right=r+"px",m=r)}v.resolve()}),v.promise},h.setCss=function(e,t){atajoui.DomUtil.cachedStyles(o(e),t)};var C={};e.$on("$destroy",function(){for(var e in C)C[e]=null})}]),o.controller("$auiInfiniteScroll",["$scope","$attrs","$element","$timeout",function(e,t,n,i){function a(){atajoui.requestAnimationFrame(function(){n[0].classList.add("active")}),l.isLoading=!0,e.$parent&&e.$parent.$apply(t.onInfinite||"")}function r(){atajoui.requestAnimationFrame(function(){n[0].classList.remove("active")}),i(function(){l.jsScrolling&&l.scrollView.resize(),(l.jsScrolling&&l.scrollView.__container&&l.scrollView.__container.offsetHeight>0||!l.jsScrolling)&&l.checkBounds()},30,!1),l.isLoading=!1}function o(){if(!l.isLoading){var e={};if(l.jsScrolling){e=l.getJSMaxScroll();var t=l.scrollView.getValues();(-1!==e.left&&t.left>=e.left||-1!==e.top&&t.top>=e.top)&&a()}else e=l.getNativeMaxScroll(),(-1!==e.left&&l.scrollEl.scrollLeft>=e.left-l.scrollEl.clientWidth||-1!==e.top&&l.scrollEl.scrollTop>=e.top-l.scrollEl.clientHeight)&&a()}}function s(e){var n=(t.distance||"2.5%").trim(),i=-1!==n.indexOf("%");return i?e*(1-parseFloat(n)/100):e-parseFloat(n)}var l=this;l.isLoading=!1,e.icon=function(){return c(t.icon)?t.icon:"aui-load-d"},e.spinner=function(){return c(t.spinner)?t.spinner:""},e.$on("scroll.infiniteScrollComplete",function(){r()}),e.$on("$destroy",function(){l.scrollCtrl&&l.scrollCtrl.$element&&l.scrollCtrl.$element.off("scroll",l.checkBounds),l.scrollEl&&l.scrollEl.removeEventListener&&l.scrollEl.removeEventListener("scroll",l.checkBounds)}),l.checkBounds=atajoui.Utils.throttle(o,300),l.getJSMaxScroll=function(){var e=l.scrollView.getScrollMax();return{left:l.scrollView.options.scrollingX?s(e.left):-1,top:l.scrollView.options.scrollingY?s(e.top):-1}},l.getNativeMaxScroll=function(){var e={left:l.scrollEl.scrollWidth,top:l.scrollEl.scrollHeight},t=window.getComputedStyle(l.scrollEl)||{};return{left:!e.left||"scroll"!==t.overflowX&&"auto"!==t.overflowX&&"scroll"!==l.scrollEl.style["overflow-x"]?-1:s(e.left),top:!e.top||"scroll"!==t.overflowY&&"auto"!==t.overflowY&&"scroll"!==l.scrollEl.style["overflow-y"]?-1:s(e.top)}},l.__finishInfiniteScroll=r}]),o.service("$atajoUiListDelegate",atajoui.DelegateService(["showReorder","showDelete","canSwipeItems","closeOptionButtons"])).controller("$atajoUiList",["$scope","$attrs","$atajoUiListDelegate","$atajoUiHistory",function(e,t,n,i){var a=this,r=!0,o=!1,s=!1,l=n._registerInstance(a,t.delegateHandle,function(){return i.isActiveScope(e)});e.$on("$destroy",l),a.showReorder=function(e){return arguments.length&&(o=!!e),o},a.showDelete=function(e){return arguments.length&&(s=!!e),s},a.canSwipeItems=function(e){return arguments.length&&(r=!!e),r},a.closeOptionButtons=function(){a.listView&&a.listView.clearDragEffects()}}]),o.controller("$atajoUiNavBar",["$scope","$element","$attrs","$compile","$timeout","$atajoUiNavBarDelegate","$atajoUiConfig","$atajoUiHistory",function(e,t,n,i,a,r,o,s){function u(e,t){var n=console.warn||console.log;n&&n.call(console,"navBarController."+e+" is deprecated, please use "+t+" instead")}function d(e){return I[e]?f(I[e]):void 0}function h(){for(var e=0;e<B.length;e++)if(B[e].isActive)return B[e]}function p(){for(var e=0;e<B.length;e++)if(!B[e].isActive)return B[e]}function v(e,t){e&&atajoui.DomUtil.cachedAttr(e.containerEle(),"nav-bar",t)}function g(e){atajoui.DomUtil.cachedAttr(t,"nav-swipe",e)}var m,$,w,b="hide",y="$auiNavBarController",S="primaryButtons",k="secondaryButtons",C="backButton",j="primaryButtons secondaryButtons leftButtons rightButtons title".split(" "),T=this,B=[],I={},x=!0;t.parent().data(y,T);var A=n.delegateHandle||"navBar"+atajoui.Utils.nextUid(),U=r._registerInstance(T,A);T.init=function(){t.addClass("nav-bar-container"),atajoui.DomUtil.cachedAttr(t,"nav-bar-transition",o.views.transition()),T.createHeaderBar(!1),T.createHeaderBar(!0),e.$emit("auiNavBar.init",A)},T.createHeaderBar=function(a){function r(e,t){e&&("title"===t?g.append(e):"rightButtons"==t||t==k&&"left"!=o.navBar.positionSecondaryButtons()||t==S&&"right"==o.navBar.positionPrimaryButtons()?(v||(v=f('<div class="buttons buttons-right">'),h.append(v)),t==k?v.append(e):v.prepend(e)):(p||(p=f('<div class="buttons buttons-left">'),m[C]?m[C].after(p):h.prepend(p)),t==k?p.append(e):p.prepend(e)))}var s=f('<div class="nav-bar-block">');atajoui.DomUtil.cachedAttr(s,"nav-bar",a?"active":"cached");var u=n.alignTitle||o.navBar.alignTitle(),h=f("<aui-header-bar>").addClass(n["class"]).attr("align-title",u);c(n.noTapScroll)&&h.attr("no-tap-scroll",n.noTapScroll);var p,v,g=f('<div class="title title-'+u+'">'),m={},$={};m[C]=d(C),m[C]&&h.append(m[C]),h.append(g),l(j,function(e){m[e]=d(e),r(m[e],e)});for(var w=0;w<h[0].children.length;w++)h[0].children[w].classList.add("header-item");s.append(h),t.append(i(s)(e.$new()));var y=h.data("$auiHeaderBarController");y.backButtonIcon=o.backButton.icon(),y.backButtonText=o.backButton.text();
var T={isActive:a,title:function(e){y.title(e)},setItem:function(e,t){T.removeItem(t),e?("title"===t&&T.title(""),r(e,t),m[t]&&m[t].addClass(b),$[t]=e):m[t]&&m[t].removeClass(b)},removeItem:function(e){$[e]&&($[e].scope().$destroy(),$[e].remove(),$[e]=null)},containerEle:function(){return s},headerBarEle:function(){return h},afterLeave:function(){l(j,function(e){T.removeItem(e)}),y.resetBackButton()},controller:function(){return y},destroy:function(){l(j,function(e){T.removeItem(e)}),s.scope().$destroy();for(var e in m)m[e]&&(m[e].removeData(),m[e]=null);p&&p.removeData(),v&&v.removeData(),g.removeData(),h.removeData(),s.remove(),s=h=g=p=v=null}};return B.push(T),T},T.navElement=function(e,t){return c(t)&&(I[e]=t),I[e]},T.update=function(e){var t=!e.hasHeaderBar&&e.showNavBar;e.transition=o.views.transition(),t||(e.direction="none"),T.enable(t);var n=T.isInitialized?p():h(),i=T.isInitialized?h():null,a=n.controller();a.enableBack(e.enableBack,!0),a.showBack(e.showBack,!0),a.updateBackButton(),T.title(e.title,n),T.showBar(t),e.navBarItems&&l(j,function(t){n.setItem(e.navBarItems[t],t)}),T.transition(n,i,e),T.isInitialized=!0,g("")},T.transition=function(n,i,r){function s(){for(var e=0;e<B.length;e++)B[e].isActive=!1;n.isActive=!0,v(n,"active"),v(i,"cached"),T.activeTransition=d=$=null}var l=n.controller(),c=o.transitions.navBar[r.navBarTransition]||o.transitions.navBar.none,u=r.transitionId;l.beforeEnter(r);var d=c(n,i,r.direction,r.shouldAnimate&&T.isInitialized);atajoui.DomUtil.cachedAttr(t,"nav-bar-transition",r.navBarTransition),atajoui.DomUtil.cachedAttr(t,"nav-bar-direction",r.direction),d.shouldAnimate&&r.renderEnd?v(n,"stage"):(v(n,"entering"),v(i,"leaving")),l.resetBackButton(r),d.run(0),T.activeTransition={run:function(e){d.shouldAnimate=!1,d.direction="back",d.run(e)},cancel:function(t,a,r){g(a),v(i,"active"),v(n,"cached"),d.shouldAnimate=t,d.run(0),T.activeTransition=d=null;var o;r.showBar!==T.showBar()&&T.showBar(r.showBar),r.showBackButton!==T.showBackButton()&&T.showBackButton(r.showBackButton),o&&e.$apply()},complete:function(e,t){g(t),d.shouldAnimate=e,d.run(1),$=s}},a(l.align,16),(m=function(){w===u&&(v(n,"entering"),v(i,"leaving"),d.run(1),$=function(){w!=u&&d.shouldAnimate||s()},m=null)})()},T.triggerTransitionStart=function(e){w=e,m&&m()},T.triggerTransitionEnd=function(){$&&$()},T.showBar=function(t){return arguments.length&&(T.visibleBar(t),e.$parent.$hasHeader=!!t),!!e.$parent.$hasHeader},T.visibleBar=function(e){e&&!x?(t.removeClass(b),T.align()):!e&&x&&t.addClass(b),x=e},T.enable=function(e){T.visibleBar(e);for(var t=0;t<r._instances.length;t++)r._instances[t]!==T&&r._instances[t].visibleBar(!1)},T.showBackButton=function(t){if(arguments.length){for(var n=0;n<B.length;n++)B[n].controller().showNavBack(!!t);e.$isBackButtonShown=!!t}return e.$isBackButtonShown},T.showActiveBackButton=function(e){var t=h();return t?arguments.length?t.controller().showBack(e):t.controller().showBack():void 0},T.title=function(t,n){return c(t)&&(t=t||"",n=n||h(),n&&n.title(t),e.$title=t,s.currentTitle(t)),e.$title},T.align=function(e,t){t=t||h(),t&&t.controller().align(e)},T.hasTabsTop=function(e){t[e?"addClass":"removeClass"]("nav-bar-tabs-top")},T.hasBarSubheader=function(e){t[e?"addClass":"removeClass"]("nav-bar-has-subheader")},T.changeTitle=function(e){u("changeTitle(val)","title(val)"),T.title(e)},T.setTitle=function(e){u("setTitle(val)","title(val)"),T.title(e)},T.getTitle=function(){return u("getTitle()","title()"),T.title()},T.back=function(){u("back()","$atajoUiHistory.goBack()"),s.goBack()},T.getPreviousTitle=function(){u("getPreviousTitle()","$atajoUiHistory.backTitle()"),s.goBack()},e.$on("$destroy",function(){e.$parent.$hasHeader=!1,t.parent().removeData(y);for(var n=0;n<B.length;n++)B[n].destroy();t.remove(),t=B=null,U()})}]),o.controller("$atajoUiNavView",["$scope","$element","$attrs","$compile","$controller","$atajoUiNavBarDelegate","$atajoUiNavViewDelegate","$atajoUiHistory","$atajoUiViewSwitcher","$atajoUiConfig","$atajoUiScrollDelegate","$atajoUiSideMenuDelegate",function(e,t,n,i,a,r,o,l,c,u,d,f){function h(e,n){for(var i,a,r=t.children(),o=0,s=r.length;s>o;o++)if(i=r.eq(o),A(i)==T){a=i.scope(),a&&a.$emit(e.name.replace("Tabs","View"),n),a&&a.$broadcast(e.name.replace("Tabs","ParentView"),n);break}}function p(e){atajoui.DomUtil.cachedAttr(t,"nav-swipe",e)}function v(e,t){var n=m();n&&n.hasTabsTop(t)}function g(e,t){var n=m();n&&n.hasBarSubheader(t)}function m(){if(w)for(var e=0;e<r._instances.length;e++)if(r._instances[e].$$delegateHandle==w)return r._instances[e];return t.inheritedData("$auiNavBarController")}var $,w,b,y,S,k="$eleId",C="$destroyEle",j="$noCache",T="active",B="cached",I=this,x=!1,A=c.navViewAttr;I.scope=e,I.element=t,I.init=function(){var i=n.name||"",a=t.parent().inheritedData("$uiView"),r=a&&a.state?a.state.name:"";i.indexOf("@")<0&&(i=i+"@"+r);var s={name:i,state:null};t.data("$uiView",s);var l=o._registerInstance(I,n.delegateHandle);return e.$on("$destroy",function(){l(),I.isSwipeFreeze&&d.freezeAllScrolls(!1)}),e.$on("$atajoUiHistory.deselect",I.cacheCleanup),e.$on("$atajoUiTabs.top",v),e.$on("$atajoUiSubheader",g),e.$on("$atajoUiTabs.beforeLeave",h),e.$on("$atajoUiTabs.afterLeave",h),e.$on("$atajoUiTabs.leave",h),atajoui.Platform.ready(function(){atajoui.Platform.isWebView()&&atajoui.Platform.isIOS()&&I.initSwipeBack()}),s},I.register=function(t){var n=s({},l.currentView()),i=l.register(e,t);I.update(i);var a=l.getViewById(i.viewId)||{},r=y!==i.viewId;I.render(i,t,a,n,r,!0)},I.update=function(e){x=!0,$=e.direction;var n=t.parent().inheritedData("$auiNavViewController");n&&(n.isPrimary(!1),("enter"===$||"exit"===$)&&(n.direction($),"enter"===$&&($="none")))},I.render=function(e,t,n,i,a,r){var o=c.create(I,t,n,i,a,r);o.init(e,function(){o.transition(I.direction(),e.enableBack,!S),y=S=null})},I.beforeEnter=function(e){if(x){w=e.navBarDelegate;var t=m();t&&t.update(e),p("")}},I.activeEleId=function(e){return arguments.length&&(b=e),b},I.transitionEnd=function(){var e,n,i,a=t.children();for(e=0,n=a.length;n>e;e++)i=a.eq(e),i.data(k)===b?A(i,T):("leaving"===A(i)||A(i)===T||A(i)===B)&&(i.data(C)||i.data(j)?c.destroyViewEle(i):(A(i,B),atajoui.Utils.disconnectScope(i.scope())));p(""),I.isSwipeFreeze&&d.freezeAllScrolls(!1)},I.cacheCleanup=function(){for(var e=t.children(),n=0,i=e.length;i>n;n++)e.eq(n).data(C)&&c.destroyViewEle(e.eq(n))},I.clearCache=function(e){var n,i,a,r,o,s,l=t.children();for(a=0,r=l.length;r>a;a++)if(n=l.eq(a),e)for(s=n.data(k),o=0;o<e.length;o++)s===e[o]&&c.destroyViewEle(n);else A(n)==B?c.destroyViewEle(n):A(n)==T&&(i=n.scope(),i&&i.$broadcast("$atajoUiView.clearCache"))},I.getViewElements=function(){return t.children()},I.appendViewElement=function(n,r){var o=i(n);t.append(n);var s=e.$new();if(r&&r.$$controller){r.$scope=s;var l=a(r.$$controller,r);r.$$controllerAs&&(s[r.$$controllerAs]=l),t.children().data("$ngControllerController",l)}return o(s),s},I.title=function(e){var t=m();t&&t.title(e)},I.enableBackButton=function(e){var t=m();t&&t.enableBackButton(e)},I.showBackButton=function(e){var t=m();return t?arguments.length?t.showActiveBackButton(e):t.showActiveBackButton():!0},I.showBar=function(e){var t=m();return t?arguments.length?t.showBar(e):t.showBar():!0},I.isPrimary=function(e){return arguments.length&&(x=e),x},I.direction=function(e){return arguments.length&&($=e),$},I.initSwipeBack=function(){function n(e){if(x&&u.views.swipeBackEnabled()&&!f.isOpenRight()&&(k=r(e),!(k>j))){v=l.backView();var n=l.currentView();if(v&&v.historyId===n.historyId&&n.canSwipeBack!==!1){b||(b=window.innerWidth),I.isSwipeFreeze=d.freezeAllScrolls(!0);var o={direction:"back"};C=[],T={showBar:I.showBar(),showBackButton:I.showBackButton()};var p=c.create(I,o,v,n,!0,!1);p.loadViewElements(o),p.render(o),s=p.transition("back",l.enabledBack(v),!0),h=m(),$=atajoui.onGesture("drag",i,t[0]),w=atajoui.onGesture("release",a,t[0])}}}function i(e){if(x&&s){var t=r(e);if(C.push({t:Date.now(),x:t}),t>=b-15)a(e);else{var n=Math.min(Math.max(o(t),0),1);s.run(n),h&&h.activeTransition&&h.activeTransition.run(n)}}}function a(e){if(x&&s&&C&&C.length>1){for(var t=Date.now(),n=r(e),l=C[C.length-1],c=C.length-2;c>=0&&!(t-l.t>200);c--)l=C[c];var u=n>=C[C.length-2].x,f=o(n),g=Math.abs(l.x-n)/(t-l.t);if(y=v.viewId,S=.03>f||f>.97,u&&(f>.5||g>.1)){var m=g>.5||.05>g||n>b-45?"fast":"slow";p(S?"":m),v.go(),h&&h.activeTransition&&h.activeTransition.complete(!S,m)}else p(S?"":"fast"),y=null,s.cancel(!S),h&&h.activeTransition&&h.activeTransition.cancel(!S,"fast",T),S=null}atajoui.offGesture($,"drag",i),atajoui.offGesture(w,"release",a),b=s=C=null,I.isSwipeFreeze=d.freezeAllScrolls(!1)}function r(e){return atajoui.tap.pointerCoord(e.gesture.srcEvent).x}function o(e){return(e-k)/b}var s,h,v,g,$,w,b,k,C,j=u.views.swipeBackHitWidth(),T={};g=atajoui.onGesture("dragstart",n,t[0]),e.$on("$destroy",function(){atajoui.offGesture(g,"dragstart",n),atajoui.offGesture($,"drag",i),atajoui.offGesture(w,"release",a),I.element=s=h=null})}}]),o.controller("$atajoUiRefresher",["$scope","$attrs","$element","$atajoUiBind","$timeout",function(e,t,n,i,a){function r(e){e.touches=e.touches||[{screenX:e.screenX,screenY:e.screenY}],V=Math.floor(e.touches[0].screenY)}function o(e){e.touches=e.touches||[{screenX:e.screenX,screenY:e.screenY}],V=e.touches[0].screenY}function s(){V=null,(P||j)&&(j?(j=!1,B=0,I>x?($(),p(x,U)):(p(0,U,m),T=!1)):(B=0,T=!1,h(!1)))}function l(e){if(e.touches=e.touches||[{screenX:e.screenX,screenY:e.screenY}],(V||"mousemove"!=e.type)&&P&&!(e.touches.length>1)){if(null===V&&(V=e.touches[0].screenY),E=e.touches[0].screenY-V,atajoui.Platform.isAndroid()&&4.4===atajoui.Platform.version()&&!atajoui.Platform.isCrosswalk()&&0===S.scrollTop&&E>0&&(j=!0,e.preventDefault()),0>=E-B||0!==S.scrollTop)return T&&(T=!1,h(!1)),j&&f(S,E- -1*B),void(0!==I&&d(0));E>0&&0===S.scrollTop&&!T&&(B=E),e.preventDefault(),T||(T=!0,h(!0)),j=!0,d((E-B)/3),!A&&I>x?(A=!0,atajoui.requestAnimationFrame(g)):A&&x>I&&(A=!1,atajoui.requestAnimationFrame(m))}}function u(e){P=0===e.target.scrollTop||j}function d(e){k.style[atajoui.CSS.TRANSFORM]="translate3d(0px, "+e+"px, 0px)",I=e}function f(e,t){e.scrollTop=t;var n=document.createEvent("UIEvents");n.initUIEvent("scroll",!0,!0,window,1),e.dispatchEvent(n)}function h(e){e?atajoui.requestAnimationFrame(function(){k.classList.add("overscroll"),w()}):atajoui.requestAnimationFrame(function(){k.classList.remove("overscroll"),b(),m()})}function p(e,t,n){function i(e){return--e*e*e+1}function a(){var s=Date.now(),l=Math.min(1,(s-r)/t),c=i(l);d(Math.floor(c*(e-o)+o)),1>l?atajoui.requestAnimationFrame(a):(5>e&&e>-5&&(T=!1,h(!1)),n&&n())}var r=Date.now(),o=I;return o===e?void n():void atajoui.requestAnimationFrame(a)}function v(){k&&(atajoui.off(_,o,k),atajoui.off(D,l,k),atajoui.off(L,s,k),atajoui.off("mousedown",r,k),atajoui.off("mousemove",l,k),atajoui.off("mouseup",s,k)),S&&atajoui.off("scroll",u,S),S=null,k=null}function g(){n[0].classList.add("active"),e.$onPulling()}function m(){a(function(){n.removeClass("active refreshing refreshing-tail"),A&&(A=!1)},150)}function $(){n[0].classList.add("refreshing");var t=e.$onRefresh();t&&t.then&&t["finally"](function(){e.$broadcast("scroll.refreshComplete")})}function w(){n[0].classList.remove("invisible")}function b(){n[0].classList.add("invisible")}function y(){n[0].classList.add("refreshing-tail")}var S,k,C=this,j=!1,T=!1,B=0,I=0,x=60,A=!1,U=500,V=null,E=null,P=!0;c(t.pullingIcon)||t.$set("pullingIcon","aui-android-arrow-down"),e.showSpinner=!c(t.refreshingIcon)&&"none"!=t.spinner,e.showIcon=c(t.refreshingIcon),i(e,t,{pullingIcon:"@",pullingText:"@",refreshingIcon:"@",refreshingText:"@",spinner:"@",disablePullingRotation:"@",$onRefresh:"&onRefresh",$onPulling:"&onPulling"}),e.$on("scroll.refreshComplete",function(){a(function(){atajoui.requestAnimationFrame(y),p(0,U,m),a(function(){T&&(T=!1,h(!1))},U)},U)});var _,D,L;window.navigator.pointerEnabled?(_="pointerdown",D="pointermove",L="pointerup"):window.navigator.msPointerEnabled?(_="MSPointerDown",D="MSPointerMove",L="MSPointerUp"):(_="touchstart",D="touchmove",L="touchend"),C.init=function(){if(S=n.parent().parent()[0],k=n.parent()[0],!(S&&S.classList.contains("atajoui-scroll")&&k&&k.classList.contains("scroll")))throw new Error("Refresher must be immediate child of aui-content or aui-scroll");atajoui.on(_,o,k),atajoui.on(D,l,k),atajoui.on(L,s,k),atajoui.on("mousedown",r,k),atajoui.on("mousemove",l,k),atajoui.on("mouseup",s,k),atajoui.on("scroll",u,S),e.$on("$destroy",v)},C.getRefresherDomMethods=function(){return{activate:g,deactivate:m,start:$,show:w,hide:b,tail:y}},C.__handleTouchmove=l,C.__getScrollChild=function(){return k},C.__getScrollParent=function(){return S}}]),o.controller("$atajoUiScroll",["$scope","scrollViewOptions","$timeout","$window","$location","$document","$atajoUiScrollDelegate","$atajoUiHistory",function(e,t,n,i,a,r,o,s){var l=this;l.__timeout=n,l._scrollViewOptions=t,l.isNative=function(){return!!t.nativeScrolling};var u,d=l.element=t.el,h=l.$element=f(d);u=l.isNative()?l.scrollView=new atajoui.views.ScrollNative(t):l.scrollView=new atajoui.views.Scroll(t),(h.parent().length?h.parent():h).data("$$atajoUiScrollController",l);var p=o._registerInstance(l,t.delegateHandle,function(){return s.isActiveScope(e)});c(t.bouncing)||atajoui.Platform.ready(function(){u&&u.options&&(u.options.bouncing=!0,atajoui.Platform.isAndroid()&&(u.options.bouncing=!1,u.options.deceleration=.95))});var v=angular.bind(u,u.resize);angular.element(i).on("resize",v);var g=function(t){var n=(t.originalEvent||t).detail||{};e.$onScroll&&e.$onScroll({event:t,scrollTop:n.scrollTop||0,scrollLeft:n.scrollLeft||0})};h.on("scroll",g),e.$on("$destroy",function(){p(),u&&u.__cleanup&&u.__cleanup(),angular.element(i).off("resize",v),h&&h.off("scroll",g),l._scrollViewOptions&&(l._scrollViewOptions.el=null),t&&(t.el=null),u=l.scrollView=t=l._scrollViewOptions=d=l.$element=h=null}),n(function(){u&&u.run&&u.run()}),l.getScrollView=function(){return u},l.getScrollPosition=function(){return u.getValues()},l.resize=function(){return n(v,0,!1).then(function(){h&&h.triggerHandler("scroll-resize")})},l.scrollTop=function(e){l.resize().then(function(){u&&u.scrollTo(0,0,!!e)})},l.scrollBottom=function(e){l.resize().then(function(){if(u){var t=u.getScrollMax();u.scrollTo(t.left,t.top,!!e)}})},l.scrollTo=function(e,t,n){l.resize().then(function(){u&&u.scrollTo(e,t,!!n)})},l.zoomTo=function(e,t,n,i){l.resize().then(function(){u&&u.zoomTo(e,!!t,n,i)})},l.zoomBy=function(e,t,n,i){l.resize().then(function(){u&&u.zoomBy(e,!!t,n,i)})},l.scrollBy=function(e,t,n){l.resize().then(function(){u&&u.scrollBy(e,t,!!n)})},l.anchorScroll=function(e){l.resize().then(function(){if(u){var t=a.hash(),n=t&&r[0].getElementById(t);if(!t||!n)return void u.scrollTo(0,0,!!e);var i=n,o=0,s=0;do null!==i&&(o+=i.offsetLeft),null!==i&&(s+=i.offsetTop),i=i.offsetParent;while(i.attributes!=l.element.attributes&&i.offsetParent);u.scrollTo(o,s,!!e)}})},l.freezeScroll=u.freeze,l.freezeScrollShut=u.freezeShut,l.freezeAllScrolls=function(e){for(var t=0;t<o._instances.length;t++)o._instances[t].freezeScroll(e)},l._setRefresher=function(e,t,n){l.refresher=t;var i=l.refresher.clientHeight||60;u.activatePullToRefresh(i,n)}}]),o.controller("$atajoUiSideMenus",["$scope","$attrs","$atajoUiSideMenuDelegate","$atajoUiPlatform","$atajoUiBody","$atajoUiHistory","$atajoUiScrollDelegate","ATAJOUI_BACK_PRIORITY","$rootScope",function(e,t,n,i,a,r,o,s,l){var c,d,f,p,v,g,m,$=this,w=!0;$.$scope=e,$.initialize=function(e){$.left=e.left,$.right=e.right,$.setContent(e.content),$.dragThresholdX=e.dragThresholdX||10,r.registerHistory($.$scope)},$.setContent=function(e){e&&($.content=e,$.content.onDrag=function(e){$._handleDrag(e)},$.content.endDrag=function(e){$._endDrag(e)})},$.isOpenLeft=function(){return $.getOpenAmount()>0},$.isOpenRight=function(){return $.getOpenAmount()<0},$.toggleLeft=function(e){if(!m&&$.left.isEnabled){var t=$.getOpenAmount();0===arguments.length&&(e=0>=t),$.content.enableAnimation(),e?($.openPercentage(100),l.$emit("$atajoUiSideMenuOpen","left")):($.openPercentage(0),l.$emit("$atajoUiSideMenuClose","left"))}},$.toggleRight=function(e){if(!m&&$.right.isEnabled){var t=$.getOpenAmount();0===arguments.length&&(e=t>=0),$.content.enableAnimation(),e?($.openPercentage(-100),l.$emit("$atajoUiSideMenuOpen","right")):($.openPercentage(0),l.$emit("$atajoUiSideMenuClose","right"))}},$.toggle=function(e){"right"==e?$.toggleRight():$.toggleLeft()},$.close=function(){$.openPercentage(0),l.$emit("$atajoUiSideMenuClose","left"),l.$emit("$atajoUiSideMenuClose","right")},$.getOpenAmount=function(){return $.content&&$.content.getTranslateX()||0},$.getOpenRatio=function(){var e=$.getOpenAmount();return e>=0?e/$.left.width:e/$.right.width},$.isOpen=function(){return 0!==$.getOpenAmount()},$.getOpenPercentage=function(){return 100*$.getOpenRatio()},$.openPercentage=function(e){var t=e/100;$.left&&e>=0?$.openAmount($.left.width*t):$.right&&0>e&&$.openAmount($.right.width*t),a.enableClass(0!==e,"menu-open"),$.content.setCanScroll(0==e)},$.openAmount=function(e){var t=$.left&&$.left.width||0,n=$.right&&$.right.width||0;return($.left&&$.left.isEnabled||!(e>0))&&($.right&&$.right.isEnabled||!(0>e))?d&&e>t?void $.content.setTranslateX(t):c&&-n>e?void $.content.setTranslateX(-n):($.content.setTranslateX(e),void(e>=0?(d=!0,c=!1,e>0&&($.right&&$.right.pushDown&&$.right.pushDown(),$.left&&$.left.bringUp&&$.left.bringUp())):(c=!0,d=!1,$.right&&$.right.bringUp&&$.right.bringUp(),$.left&&$.left.pushDown&&$.left.pushDown()))):void $.content.setTranslateX(0)},$.snapToRest=function(e){$.content.enableAnimation(),f=!1;var t=$.getOpenRatio();if(0===t)return void $.openPercentage(0);var n=.3,i=e.gesture.velocityX,a=e.gesture.direction;t>0&&.5>t&&"right"==a&&n>i?$.openPercentage(0):t>.5&&"left"==a&&n>i?$.openPercentage(100):0>t&&t>-.5&&"left"==a&&n>i?$.openPercentage(0):.5>t&&"right"==a&&n>i?$.openPercentage(-100):"right"==a&&t>=0&&(t>=.5||i>n)?$.openPercentage(100):"left"==a&&0>=t&&(-.5>=t||i>n)?$.openPercentage(-100):$.openPercentage(0)},$.enableMenuWithBackViews=function(e){return arguments.length&&(w=!!e),w},$.isAsideExposed=function(){return!!m},$.exposeAside=function(e){($.left&&$.left.isEnabled||$.right&&$.right.isEnabled)&&($.close(),m=e,$.left&&$.left.isEnabled&&$.right&&$.right.isEnabled?$.content.setMarginLeftAndRight(m?$.left.width:0,m?$.right.width:0):$.left&&$.left.isEnabled?$.content.setMarginLeft(m?$.left.width:0):$.right&&$.right.isEnabled&&$.content.setMarginRight(m?$.right.width:0),$.$scope.$emit("$atajoUiExposeAside",m))},$.activeAsideResizing=function(e){a.enableClass(e,"aside-resizing")},$._endDrag=function(e){m||(f&&$.snapToRest(e),p=null,v=null,g=null)},$._handleDrag=function(t){!m&&e.dragContent&&(p?v=t.gesture.touches[0].pageX:(p=t.gesture.touches[0].pageX,v=p),!f&&Math.abs(v-p)>$.dragThresholdX&&(p=v,f=!0,$.content.disableAnimation(),g=$.getOpenAmount()),f&&$.openAmount(g+(v-p)))},$.canDragContent=function(t){return arguments.length&&(e.dragContent=!!t),e.dragContent},$.edgeThreshold=25,$.edgeThresholdEnabled=!1,$.edgeDragThreshold=function(e){return arguments.length&&(u(e)&&e>0?($.edgeThreshold=e,$.edgeThresholdEnabled=!0):$.edgeThresholdEnabled=!!e),$.edgeThresholdEnabled},$.isDraggableTarget=function(t){var n=$.edgeThresholdEnabled&&!$.isOpen(),i=t.gesture.startEvent&&t.gesture.startEvent.center&&t.gesture.startEvent.center.pageX,a=!n||i<=$.edgeThreshold||i>=$.content.element.offsetWidth-$.edgeThreshold,o=r.backView(),s=w?!0:!o;if(!s){var l=r.currentView()||{};return a&&o.historyId!==l.historyId}return(e.dragContent||$.isOpen())&&a&&!t.gesture.srcEvent.defaultPrevented&&s&&!t.target.tagName.match(/input|textarea|select|object|embed/i)&&!t.target.isContentEditable&&!(t.target.dataset?t.target.dataset.preventScroll:"true"==t.target.getAttribute("data-prevent-scroll"))},e.sideMenuContentTranslateX=0;var b=h,y=angular.bind($,$.close);e.$watch(function(){return 0!==$.getOpenAmount()},function(e){b(),e&&(b=i.registerBackButtonAction(y,s.sideMenu))});var S=n._registerInstance($,t.delegateHandle,function(){return r.isActiveScope(e)});e.$on("$destroy",function(){S(),b(),$.$scope=null,$.content&&($.content.setCanScroll(!0),$.content.element=null,$.content=null)}),$.initialize({left:{width:275},right:{width:275}})}]),function(e){function t(e,i,a,r){var o,s,l,c=document.createElement(f[e]||e);for(o in i)if(angular.isArray(i[o]))for(s=0;s<i[o].length;s++)if(i[o][s].fn)for(l=0;l<i[o][s].t;l++)t(o,i[o][s].fn(l,r),c,r);else t(o,i[o][s],c,r);else n(c,o,i[o]);a.appendChild(c)}function n(e,t,n){e.setAttribute(f[t]||t,n)}function i(e,t){var n=e.split(";"),i=n.slice(t),a=n.slice(0,n.length-i.length);return n=i.concat(a).reverse(),n.join(";")+";"+n[0]}function a(e,t){return e/=t/2,1>e?.5*e*e*e:(e-=2,.5*(e*e*e+2))}var r="translate(32,32)",s="stroke-opacity",l="round",c="indefinite",u="750ms",d="none",f={a:"animate",an:"attributeName",at:"animateTransform",c:"circle",da:"stroke-dasharray",os:"stroke-dashoffset",f:"fill",lc:"stroke-linecap",rc:"repeatCount",sw:"stroke-width",t:"transform",v:"values"},h={v:"0,32,32;360,32,32",an:"transform",type:"rotate",rc:c,dur:u},p={sw:4,lc:l,line:[{fn:function(e,t){return{y1:"ios"==t?17:12,y2:"ios"==t?29:20,t:r+" rotate("+(30*e+(6>e?180:-180))+")",a:[{fn:function(){return{an:s,dur:u,v:i("0;.1;.15;.25;.35;.45;.55;.65;.7;.85;1",e),rc:c}},t:1}]}},t:12}]},v={android:{c:[{sw:6,da:128,os:82,r:26,cx:32,cy:32,f:d}]},ios:p,"ios-small":p,bubbles:{sw:0,c:[{fn:function(e){return{cx:24*Math.cos(2*Math.PI*e/8),cy:24*Math.sin(2*Math.PI*e/8),t:r,a:[{fn:function(){return{an:"r",dur:u,v:i("1;2;3;4;5;6;7;8",e),rc:c}},t:1}]}},t:8}]},circles:{c:[{fn:function(e){return{r:5,cx:24*Math.cos(2*Math.PI*e/8),cy:24*Math.sin(2*Math.PI*e/8),t:r,sw:0,a:[{fn:function(){return{an:"fill-opacity",dur:u,v:i(".3;.3;.3;.4;.7;.85;.9;1",e),rc:c}},t:1}]}},t:8}]},crescent:{c:[{sw:4,da:128,os:82,r:26,cx:32,cy:32,f:d,at:[h]}]},dots:{c:[{fn:function(e){return{cx:16+16*e,cy:32,sw:0,a:[{fn:function(){return{an:"fill-opacity",dur:u,v:i(".5;.6;.8;1;.8;.6;.5",e),rc:c}},t:1},{fn:function(){return{an:"r",dur:u,v:i("4;5;6;5;4;3;3",e),rc:c}},t:1}]}},t:3}]},lines:{sw:7,lc:l,line:[{fn:function(e){return{x1:10+14*e,x2:10+14*e,a:[{fn:function(){return{an:"y1",dur:u,v:i("16;18;28;18;16",e),rc:c}},t:1},{fn:function(){return{an:"y2",dur:u,v:i("48;44;36;46;48",e),rc:c}},t:1},{fn:function(){return{an:s,dur:u,v:i("1;.8;.5;.4;1",e),rc:c}},t:1}]}},t:4}]},ripple:{f:d,"fill-rule":"evenodd",sw:3,circle:[{fn:function(e){return{cx:32,cy:32,a:[{fn:function(){return{an:"r",begin:-1*e+"s",dur:"2s",v:"0;24",keyTimes:"0;1",keySplines:"0.1,0.2,0.3,1",calcMode:"spline",rc:c}},t:1},{fn:function(){return{an:s,begin:-1*e+"s",dur:"2s",v:".2;1;.2;0",rc:c}},t:1}]}},t:2}]},spiral:{defs:[{linearGradient:[{id:"sGD",gradientUnits:"userSpaceOnUse",x1:55,y1:46,x2:2,y2:46,stop:[{offset:.1,"class":"stop1"},{offset:1,"class":"stop2"}]}]}],g:[{sw:4,lc:l,f:d,path:[{stroke:"url(#sGD)",d:"M4,32 c0,15,12,28,28,28c8,0,16-4,21-9"},{d:"M60,32 C60,16,47.464,4,32,4S4,16,4,32"}],at:[h]}]}},g={android:function(t){function i(){if(!r.stop){var t=a(Date.now()-o,650),d=1,f=0,h=188-58*t,p=182-182*t;s%2&&(d=-1,f=-64,h=128- -58*t,p=182*t);var v=[0,-101,-90,-11,-180,79,-270,-191][s];n(u,"da",Math.max(Math.min(h,188),128)),n(u,"os",Math.max(Math.min(p,182),0)),n(u,"t","scale("+d+",1) translate("+f+",0) rotate("+v+",32,32)"),l+=4.1,l>359&&(l=0),n(c,"t","rotate("+l+",32,32)"),t>=1&&(s++,s>7&&(s=0),o=Date.now()),e.requestAnimationFrame(i)}}var r={};this.stop=!1;var o,s=0,l=0,c=t.querySelector("g"),u=t.querySelector("circle");return function(){return o=Date.now(),i(),r}}};o.controller("$atajoUiSpinner",["$element","$attrs","$atajoUiConfig",function(e,n,i){var a,r;this.init=function(){a=n.icon||i.spinner.icon();var r=document.createElement("div");return t("svg",{viewBox:"0 0 64 64",g:[v[a]]},r,a),e.html(r.innerHTML),this.start(),a},this.start=function(){g[a]&&(r=g[a](e[0])())},this.stop=function(){g[a]&&(r.stop=!0)}}])}(atajoui),o.controller("$atajoUiTab",["$scope","$atajoUiHistory","$attrs","$location","$state",function(e,t,n,i,a){this.$scope=e,this.hrefMatchesState=function(){return n.href&&0===i.path().indexOf(n.href.replace(/^#/,"").replace(/\/$/,""))},this.srefMatchesState=function(){return n.uiSref&&a.includes(n.uiSref.split("(")[0])},this.navNameMatchesState=function(){return this.navViewName&&t.isCurrentStateNavView(this.navViewName)},this.tabMatchesState=function(){return this.hrefMatchesState()||this.srefMatchesState()||this.navNameMatchesState()}}]),o.controller("$atajoUiTabs",["$scope","$element","$atajoUiHistory",function(e,t,n){var i,a=this,r=null,o=null,s=!0;a.tabs=[],a.selectedIndex=function(){return a.tabs.indexOf(r)},a.selectedTab=function(){return r},a.previousSelectedTab=function(){return o},a.add=function(e){n.registerHistory(e),a.tabs.push(e)},a.remove=function(e){var t=a.tabs.indexOf(e);if(-1!==t){if(e.$tabSelected)if(a.deselect(e),1===a.tabs.length);else{var n=t===a.tabs.length-1?t-1:t+1;a.select(a.tabs[n])}a.tabs.splice(t,1)}},a.deselect=function(e){e.$tabSelected&&(o=r,r=i=null,e.$tabSelected=!1,(e.onDeselect||h)(),e.$broadcast&&e.$broadcast("$atajoUiHistory.deselect"))},a.select=function(t,o){var s;if(u(t)){if(s=t,s>=a.tabs.length)return;t=a.tabs[s]}else s=a.tabs.indexOf(t);1===arguments.length&&(o=!(!t.navViewName&&!t.uiSref)),r&&r.$historyId==t.$historyId?o&&n.goToHistoryRoot(t.$historyId):i!==s&&(l(a.tabs,function(e){a.deselect(e)}),r=t,i=s,a.$scope&&a.$scope.$parent&&(a.$scope.$parent.$activeHistoryId=t.$historyId),t.$tabSelected=!0,(t.onSelect||h)(),o&&e.$emit("$atajoUiHistory.change",{type:"tab",tabIndex:s,historyId:t.$historyId,navViewName:t.navViewName,hasNavView:!!t.navViewName,title:t.title,url:t.href,uiSref:t.uiSref}),e.$broadcast("tabSelected",{selectedTab:t,selectedTabIndex:s}))},a.hasActiveScope=function(){for(var e=0;e<a.tabs.length;e++)if(n.isActiveScope(a.tabs[e]))return!0;return!1},a.showBar=function(e){return arguments.length&&(e?t.removeClass("tabs-item-hide"):t.addClass("tabs-item-hide"),s=!!e),s}}]),o.controller("$atajoUiView",["$scope","$element","$attrs","$compile","$rootScope",function(e,t,n,i,a){function r(){var t=c(n.viewTitle)&&"viewTitle"||c(n.title)&&"title";t&&(o(n[t]),$.push(n.$observe(t,o))),c(n.hideBackButton)&&$.push(e.$watch(n.hideBackButton,function(e){f.showBackButton(!e)})),c(n.hideNavBar)&&$.push(e.$watch(n.hideNavBar,function(e){f.showBar(!e)}))}function o(e){c(e)&&e!==v&&(v=e,f.title(v))}function l(){for(var e=0;e<$.length;e++)$[e]();$=[]}function u(t){return t?i(t)(e.$new()):void 0}function d(t){return!!e.$eval(n[t])}var f,h,p,v,g=this,m={},$=[],w=e.$on("auiNavBar.init",function(e,t){e.stopPropagation(),h=t});g.init=function(){w();var n=t.inheritedData("$auiModalController");f=t.inheritedData("$auiNavViewController"),f&&!n&&(e.$on("$atajoUiView.beforeEnter",g.beforeEnter),e.$on("$atajoUiView.afterEnter",r),e.$on("$atajoUiView.beforeLeave",l))},g.beforeEnter=function(t,i){if(i&&!i.viewNotified){i.viewNotified=!0,a.$$phase||e.$digest(),v=c(n.viewTitle)?n.viewTitle:n.title;var r={};for(var o in m)r[o]=u(m[o]);f.beforeEnter(s(i,{title:v,showBack:!d("hideBackButton"),navBarItems:r,navBarDelegate:h||null,showNavBar:!d("hideNavBar"),hasHeaderBar:!!p})),l()}},g.navElement=function(e,t){m[e]=t}}]),o.directive("auiActionSheet",["$document",function(e){return{restrict:"E",scope:!0,replace:!0,link:function(t,n){var i=function(e){27==e.which&&(t.cancel(),t.$apply())},a=function(e){e.target==n[0]&&(t.cancel(),t.$apply())};t.$on("$destroy",function(){n.remove(),e.unbind("keyup",i)}),e.bind("keyup",i),n.bind("click",a)},template:'<div class="actaui-sheet-backdrop"><div class="actaui-sheet-wrapper"><div class="actaui-sheet" ng-class="{\'actaui-sheet-has-icons\': $actionSheetHasIcon}"><div class="actaui-sheet-group actaui-sheet-options"><div class="actaui-sheet-title" ng-if="titleText" ng-bind-html="titleText"></div><button class="button actaui-sheet-option" ng-click="buttonClicked($index)" ng-class="b.className" ng-repeat="b in buttons" ng-bind-html="b.text"></button><button class="button destructive actaui-sheet-destructive" ng-if="destructiveText" ng-click="destructiveButtonClicked()" ng-bind-html="destructiveText"></button></div><div class="actaui-sheet-group actaui-sheet-cancel" ng-if="cancelText"><button class="button" ng-click="cancel()" ng-bind-html="cancelText"></button></div></div></div></div>'}}]),o.directive("auiCheckbox",["$atajoUiConfig",function(e){return{restrict:"E",replace:!0,require:"?ngModel",transclude:!0,template:'<label class="item item-checkbox"><div class="checkbox checkbox-input-hidden disable-pointer-events"><input type="checkbox"><i class="checkbox-icon"></i></div><div class="item-content disable-pointer-events" ng-transclude></div></label>',compile:function(t,n){var i=t.find("input");l({name:n.name,"ng-value":n.ngValue,"ng-model":n.ngModel,"ng-checked":n.ngChecked,"ng-disabled":n.ngDisabled,"ng-true-value":n.ngTrueValue,"ng-false-value":n.ngFalseValue,"ng-change":n.ngChange,"ng-required":n.ngRequired,required:n.required},function(e,t){c(e)&&i.attr(t,e)});var a=t[0].querySelector(".checkbox");a.classList.add("checkbox-"+e.form.checkbox())}}}]),o.directive("collectionRepeat",e).factory("$atajoUiCollectionManager",t);var g="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",m=/height:.*?px;\s*width:.*?px/,$=3;e.$inject=["$atajoUiCollectionManager","$parse","$window","$$rAF","$rootScope","$timeout"],t.$inject=["$rootScope","$window","$$rAF"],o.directive("auiContent",["$timeout","$controller","$atajoUiBind","$atajoUiConfig",function(e,t,n,i){return{restrict:"E",require:"^?auiNavView",scope:!0,priority:800,compile:function(e,a){function r(e,i,r){function u(){e.$onScrollComplete({scrollTop:s.scrollView.__scrollTop,scrollLeft:s.scrollView.__scrollLeft})}var d=e.$parent;if(e.$watch(function(){return(d.$hasHeader?" has-header":"")+(d.$hasSubheader?" has-subheader":"")+(d.$hasFooter?" has-footer":"")+(d.$hasSubfooter?" has-subfooter":"")+(d.$hasTabs?" has-tabs":"")+(d.$hasTabsTop?" has-tabs-top":"")},function(e,t){i.removeClass(t),i.addClass(e)}),e.$hasHeader=e.$hasSubheader=e.$hasFooter=e.$hasSubfooter=e.$hasTabs=e.$hasTabsTop=!1,n(e,r,{$onScroll:"&onScroll",$onScrollComplete:"&onScrollComplete",hasBouncing:"@",padding:"@",direction:"@",scrollbarX:"@",scrollbarY:"@",startX:"@",startY:"@",scrollEventInterval:"@"}),e.direction=e.direction||"y",c(r.padding)&&e.$watch(r.padding,function(e){(o||i).toggleClass("padding",!!e)}),"false"===r.scroll);else{var f={};l?(i.addClass("overflow-scroll"),f={el:i[0],delegateHandle:a.delegateHandle,startX:e.$eval(e.startX)||0,startY:e.$eval(e.startY)||0,nativeScrolling:!0}):f={el:i[0],delegateHandle:a.delegateHandle,locking:"true"===(a.locking||"true"),bouncing:e.$eval(e.hasBouncing),startX:e.$eval(e.startX)||0,startY:e.$eval(e.startY)||0,scrollbarX:e.$eval(e.scrollbarX)!==!1,scrollbarY:e.$eval(e.scrollbarY)!==!1,scrollingX:e.direction.indexOf("x")>=0,scrollingY:e.direction.indexOf("y")>=0,scrollEventInterval:parseInt(e.scrollEventInterval,10)||10,scrollingComplete:u},s=t("$atajoUiScroll",{$scope:e,scrollViewOptions:f}),e.scrollCtrl=s,e.$on("$destroy",function(){f&&(f.scrollingComplete=h,delete f.el),o=null,i=null,a.$$element=null})}}var o,s;e.addClass("scroll-content atajoui-scroll"),"false"!=a.scroll?(o=f('<div class="scroll"></div>'),o.append(e.contents()),e.append(o)):e.addClass("scroll-content-false");var l="false"!==a.overflowScroll&&("true"===a.overflowScroll||!i.scrolling.jsScrolling());return l&&(l=!e[0].querySelector("[collectaui-repeat]")),{pre:r}}}}]),o.directive("exposeAsideWhen",["$window",function(e){return{restrict:"A",require:"^auiSideMenus",link:function(t,n,i,a){function r(){var t="large"==i.exposeAsideWhen?"(min-width:768px)":i.exposeAsideWhen;a.exposeAside(e.matchMedia(t).matches),a.activeAsideResizing(!1)}function o(){a.activeAsideResizing(!0),c()}var s=e.innerWidth,l=e.innerHeight;atajoui.on("resize",function(){
(s!==e.innerWidth||l!==e.innerHeight)&&(s=e.innerWidth,l=e.innerHeight,o())},e);var c=atajoui.debounce(function(){t.$apply(r)},300,!1);t.$evalAsync(r)}}}]);var w="onHold onTap onDoubleTap onTouch onRelease onDragStart onDrag onDragEnd onDragUp onDragRight onDragDown onDragLeft onSwipe onSwipeUp onSwipeRight onSwipeDown onSwipeLeft".split(" ");w.forEach(function(e){o.directive(e,n(e))}),o.directive("auiHeaderBar",i(!0)).directive("auiFooterBar",i(!1)),o.directive("auiInfiniteScroll",["$timeout",function(e){return{restrict:"E",require:["?^$atajoUiScroll","auiInfiniteScroll"],template:function(e,t){return t.icon?'<i class="icon {{icon()}} icon-refreshing {{scrollingType}}"></i>':'<aui-spinner icon="{{spinner()}}"></aui-spinner>'},scope:!0,controller:"$auiInfiniteScroll",link:function(t,n,i,a){var r=a[1],o=r.scrollCtrl=a[0],s=r.jsScrolling=!o.isNative();if(s)r.scrollView=o.scrollView,t.scrollingType="js-scrolling",o.$element.on("scroll",r.checkBounds);else{var l=atajoui.DomUtil.getParentOrSelfWithClass(n[0].parentNode,"overflow-scroll");if(r.scrollEl=l,!l)throw"Infinite scroll must be used inside a scrollable div";r.scrollEl.addEventListener("scroll",r.checkBounds)}var u=c(i.immediateCheck)?t.$eval(i.immediateCheck):!0;u&&e(function(){r.checkBounds()})}}}]);var b=-1;o.directive("auiInput",[function(){return{restrict:"E",controller:["$scope","$element",function(e,t){this.$scope=e,this.$element=t,this.setInputAriaLabeledBy=function(e){var n=t[0].querySelectorAll("input,textarea");n.length&&n[0].setAttribute("aria-labelledby",e)},this.focus=function(){var e=t[0].querySelectorAll("input,textarea");e.length&&e[0].focus()}}]}}]),o.directive("auiLabel",[function(){return{restrict:"E",require:"?^auiInput",compile:function(){return function(e,t,n,i){var a=t[0];t.addClass("input-label"),t.attr("aria-label",t.text());var r=a.id||"_label-"+ ++b;a.id||t.attr("id",r),i&&(i.setInputAriaLabeledBy(r),t.on("click",function(){i.focus()}))}}}}]),o.directive("inputLabel",[function(){return{restrict:"C",require:"?^auiInput",compile:function(){return function(e,t,n,i){var a=t[0];t.attr("aria-label",t.text());var r=a.id||"_label-"+ ++b;a.id||t.attr("id",r),i&&i.setInputAriaLabeledBy(r)}}}}]),o.directive("auiItem",["$$rAF",function(e){return{restrict:"E",controller:["$scope","$element",function(e,t){this.$scope=e,this.$element=t}],scope:!0,compile:function(t,n){var i=c(n.href)||c(n.ngHref)||c(n.uiSref),a=i||/aui-(delete|option|reorder)-button/i.test(t.html());if(a){var r=f(i?"<a></a>":"<div></div>");r.addClass("item-content"),(c(n.href)||c(n.ngHref))&&(r.attr("ng-href","{{$href()}}"),c(n.target)&&r.attr("target","{{$target()}}")),r.append(t.contents()),t.addClass("item item-complex").append(r)}else t.addClass("item");return function(t,n,i){t.$href=function(){return i.href||i.ngHref},t.$target=function(){return i.target};var a=n[0].querySelector(".item-content");a&&t.$on("$collectionRepeatLeave",function(){a&&a.$$atajoUiOptionsOpen&&(a.style[atajoui.CSS.TRANSFORM]="",a.style[atajoui.CSS.TRANSITION]="none",e(function(){a.style[atajoui.CSS.TRANSITION]=""}),a.$$atajoUiOptionsOpen=!1)})}}}}]);var y='<div class="item-left-edit item-delete enable-pointer-events"></div>';o.directive("auiDeleteButton",function(){function e(e){e.stopPropagation()}return{restrict:"E",require:["^^auiItem","^?auiList"],priority:Number.MAX_VALUE,compile:function(t,n){return n.$set("class",(n["class"]||"")+" button icon button-icon",!0),function(t,n,i,a){function r(){s=s||n.controller("auiList"),s&&s.showDelete()&&l.addClass("visible active")}var o=a[0],s=a[1],l=f(y);l.append(n),o.$element.append(l).addClass("item-left-editable"),n.on("click",e),r(),t.$on("$atajoui.reconnectScope",r)}}}}),o.directive("itemFloatingLabel",function(){return{restrict:"C",link:function(e,t){var n=t[0],i=n.querySelector("input, textarea"),a=n.querySelector(".input-label");if(i&&a){var r=function(){i.value?a.classList.add("has-input"):a.classList.remove("has-input")};i.addEventListener("input",r);var o=f(i).controller("ngModel");o&&(o.$render=function(){i.value=o.$viewValue||"",r()}),e.$on("$destroy",function(){i.removeEventListener("input",r)})}}}});var S='<div class="item-options invisible"></div>';o.directive("auiOptionButton",[function(){function e(e){e.stopPropagation()}return{restrict:"E",require:"^auiItem",priority:Number.MAX_VALUE,compile:function(t,n){return n.$set("class",(n["class"]||"")+" button",!0),function(t,n,i,a){a.optionsContainer||(a.optionsContainer=f(S),a.$element.append(a.optionsContainer)),a.optionsContainer.append(n),a.$element.addClass("item-right-editable"),n.on("click",e)}}}}]);var k='<div data-prevent-scroll="true" class="item-right-edit item-reorder enable-pointer-events"></div>';o.directive("auiReorderButton",["$parse",function(e){return{restrict:"E",require:["^auiItem","^?auiList"],priority:Number.MAX_VALUE,compile:function(t,n){return n.$set("class",(n["class"]||"")+" button icon button-icon",!0),t[0].setAttribute("data-prevent-scroll",!0),function(t,n,i,a){var r=a[0],o=a[1],s=e(i.onReorder);t.$onReorder=function(e,n){s(t,{$fromIndex:e,$toIndex:n})},i.ngClick||i.onClick||i.onclick||(n[0].onclick=function(e){return e.stopPropagation(),!1});var l=f(k);l.append(n),r.$element.append(l).addClass("item-right-editable"),o&&o.showReorder()&&l.addClass("visible active")}}}}]),o.directive("keyboardAttach",function(){return function(e,t){function n(e){if(!atajoui.Platform.isAndroid()||atajoui.Platform.isFullScreen){var n=e.keyboardHeight||e.detail&&e.detail.keyboardHeight;t.css("bottom",n+"px"),r=t.controller("$atajoUiScroll"),r&&(r.scrollView.__container.style.bottom=n+a(t[0])+"px")}}function i(){(!atajoui.Platform.isAndroid()||atajoui.Platform.isFullScreen)&&(t.css("bottom",""),r&&(r.scrollView.__container.style.bottom=""))}atajoui.on("native.keyboardshow",n,window),atajoui.on("native.keyboardhide",i,window),atajoui.on("native.showkeyboard",n,window),atajoui.on("native.hidekeyboard",i,window);var r;e.$on("$destroy",function(){atajoui.off("native.keyboardshow",n,window),atajoui.off("native.keyboardhide",i,window),atajoui.off("native.showkeyboard",n,window),atajoui.off("native.hidekeyboard",i,window)})}}),o.directive("auiList",["$timeout",function(e){return{restrict:"E",require:["auiList","^?$atajoUiScroll"],controller:"$atajoUiList",compile:function(t,n){var i=f('<div class="list">').append(t.contents()).addClass(n.type);return t.append(i),function(t,i,a,r){function o(){function a(e,t){t()&&e.addClass("visible")||e.removeClass("active"),atajoui.requestAnimationFrame(function(){t()&&e.addClass("active")||e.removeClass("visible")})}var r=s.listView=new atajoui.views.ListView({el:i[0],listEl:i.children()[0],scrollEl:l&&l.element,scrollView:l&&l.scrollView,onReorder:function(t,n,i){var a=f(t).scope();a&&a.$onReorder&&e(function(){a.$onReorder(n,i)})},canSwipe:function(){return s.canSwipeItems()}});t.$on("$destroy",function(){r&&(r.deregister&&r.deregister(),r=null)}),c(n.canSwipe)&&t.$watch("!!("+n.canSwipe+")",function(e){s.canSwipeItems(e)}),c(n.showDelete)&&t.$watch("!!("+n.showDelete+")",function(e){s.showDelete(e)}),c(n.showReorder)&&t.$watch("!!("+n.showReorder+")",function(e){s.showReorder(e)}),t.$watch(function(){return s.showDelete()},function(e,t){if(e||t){e&&s.closeOptionButtons(),s.canSwipeItems(!e),i.children().toggleClass("list-left-editing",e),i.toggleClass("disable-pointer-events",e);var n=f(i[0].getElementsByClassName("item-delete"));a(n,s.showDelete)}}),t.$watch(function(){return s.showReorder()},function(e,t){if(e||t){e&&s.closeOptionButtons(),s.canSwipeItems(!e),i.children().toggleClass("list-right-editing",e),i.toggleClass("disable-pointer-events",e);var n=f(i[0].getElementsByClassName("item-reorder"));a(n,s.showReorder)}})}var s=r[0],l=r[1];e(o)}}}}]),o.directive("menuClose",["$atajoUiHistory","$timeout",function(e,t){return{restrict:"AC",link:function(n,i){i.bind("click",function(){var n=i.inheritedData("$auiSideMenusController");n&&(e.nextViewOptions({historyRoot:!0,disableAnimate:!0,expire:300}),t(function(){e.nextViewOptions({historyRoot:!1,disableAnimate:!1})},300),n.close())})}}}]),o.directive("menuToggle",function(){return{restrict:"AC",link:function(e,t,n){e.$on("$atajoUiView.beforeEnter",function(e,n){if(n.enableBack){var i=t.inheritedData("$auiSideMenusController");i.enableMenuWithBackViews()||t.addClass("hide")}else t.removeClass("hide")}),t.bind("click",function(){var e=t.inheritedData("$auiSideMenusController");e&&e.toggle(n.menuToggle)})}}}),o.directive("auiModal",[function(){return{restrict:"E",transclude:!0,replace:!0,controller:[function(){}],template:'<div class="modal-backdrop"><div class="modal-backdrop-bg"></div><div class="modal-wrapper" ng-transclude></div></div>'}}]),o.directive("auiModalView",function(){return{restrict:"E",compile:function(e){e.addClass("modal")}}}),o.directive("auiNavBackButton",["$atajoUiConfig","$document",function(e,t){return{restrict:"E",require:"^auiNavBar",compile:function(n,i){function a(e){return/aui-|icon/.test(e.className)}var r=t[0].createElement("button");for(var o in i.$attr)r.setAttribute(i.$attr[o],i[o]);i.ngClick||r.setAttribute("ng-click","$atajoUiGoBack()"),r.className="button back-button hide buttons "+(n.attr("class")||""),r.innerHTML=n.html()||"";for(var s,l,c,u,d=a(n[0]),f=0;f<n[0].childNodes.length;f++)s=n[0].childNodes[f],1===s.nodeType?a(s)?d=!0:s.classList.contains("default-title")?c=!0:s.classList.contains("previous-title")&&(u=!0):l||3!==s.nodeType||(l=!!s.nodeValue.trim());var h=e.backButton.icon();if(!d&&h&&"none"!==h&&(r.innerHTML='<i class="icon '+h+'"></i> '+r.innerHTML,r.className+=" button-clear"),!l){var p=t[0].createElement("span");p.className="back-text",!c&&e.backButton.text()&&(p.innerHTML+='<span class="default-title">'+e.backButton.text()+"</span>"),!u&&e.backButton.previousTitleText()&&(p.innerHTML+='<span class="previous-title"></span>'),r.appendChild(p)}return n.attr("class","hide"),n.empty(),{pre:function(e,t,n,i){i.navElement("backButton",r.outerHTML),r=null}}}}}]),o.directive("auiNavBar",function(){return{restrict:"E",controller:"$atajoUiNavBar",scope:!0,link:function(e,t,n,i){i.init()}}}),o.directive("auiNavButtons",["$document",function(e){return{require:"^auiNavBar",restrict:"E",compile:function(t,n){var i="left";/^primary|secondary|right$/i.test(n.side||"")&&(i=n.side.toLowerCase());var a=e[0].createElement("span");a.className=i+"-buttons",a.innerHTML=t.html();var r=i+"Buttons";return t.attr("class","hide"),t.empty(),{pre:function(e,t,n,i){var o=t.parent().data("$auiViewController");o?o.navElement(r,a.outerHTML):i.navElement(r,a.outerHTML),a=null}}}}}]),o.directive("navDirection",["$atajoUiViewSwitcher",function(e){return{restrict:"A",priority:1e3,link:function(t,n,i){n.bind("click",function(){e.nextDirection(i.navDirection)})}}}]),o.directive("auiNavTitle",["$document",function(e){return{require:"^auiNavBar",restrict:"E",compile:function(t,n){var i="title",a=e[0].createElement("span");for(var r in n.$attr)a.setAttribute(n.$attr[r],n[r]);return a.classList.add("nav-bar-title"),a.innerHTML=t.html(),t.attr("class","hide"),t.empty(),{pre:function(e,t,n,r){var o=t.parent().data("$auiViewController");o?o.navElement(i,a.outerHTML):r.navElement(i,a.outerHTML),a=null}}}}}]),o.directive("navTransition",["$atajoUiViewSwitcher",function(e){return{restrict:"A",priority:1e3,link:function(t,n,i){n.bind("click",function(){e.nextTransition(i.navTransition)})}}}]),o.directive("auiNavView",["$state","$atajoUiConfig",function(e,t){return{restrict:"E",terminal:!0,priority:2e3,transclude:!0,controller:"$atajoUiNavView",compile:function(n,i,a){return n.addClass("view-container"),atajoui.DomUtil.cachedAttr(n,"nav-view-transition",t.views.transition()),function(t,n,i,r){function o(t){var n=e.$current&&e.$current.locals[l.name];n&&(t||n!==s)&&(s=n,l.state=n.$$state,r.register(n))}var s;a(t,function(e){n.append(e)});var l=r.init();t.$on("$stateChangeSuccess",function(){o(!1)}),t.$on("$viewContentLoading",function(){o(!1)}),o(!0)}}}}]),o.config(["$provide",function(e){e.decorator("ngClickDirective",["$delegate",function(e){return e.shift(),e}])}]).factory("$atajoUiNgClick",["$parse",function(e){return function(t,n,i){var a=angular.isFunction(i)?i:e(i);n.on("click",function(e){t.$apply(function(){a(t,{$event:e})})}),n.onclick=h}}]).directive("ngClick",["$atajoUiNgClick",function(e){return function(t,n,i){e(t,n,i.ngClick)}}]).directive("auiStopEvent",function(){return{restrict:"A",link:function(e,t,n){t.bind(n.auiStopEvent,r)}}}),o.directive("auiPane",function(){return{restrict:"E",link:function(e,t){t.addClass("pane")}}}),o.directive("auiPopover",[function(){return{restrict:"E",transclude:!0,replace:!0,controller:[function(){}],template:'<div class="popover-backdrop"><div class="popover-wrapper" ng-transclude></div></div>'}}]),o.directive("auiPopoverView",function(){return{restrict:"E",compile:function(e){e.append(f('<div class="popover-arrow">')),e.addClass("popover")}}}),o.directive("auiRadio",function(){return{restrict:"E",replace:!0,require:"?ngModel",transclude:!0,template:'<label class="item item-radio"><input type="radio" name="radio-group"><div class="radio-content"><div class="item-content disable-pointer-events" ng-transclude></div><i class="radio-icon disable-pointer-events icon aui-checkmark"></i></div></label>',compile:function(e,t){if(t.icon){var n=e.find("i");n.removeClass("aui-checkmark").addClass(t.icon)}var i=e.find("input");return l({name:t.name,value:t.value,disabled:t.disabled,"ng-value":t.ngValue,"ng-model":t.ngModel,"ng-disabled":t.ngDisabled,"ng-change":t.ngChange,"ng-required":t.ngRequired,required:t.required},function(e,t){c(e)&&i.attr(t,e)}),function(e,t,n){e.getValue=function(){return e.ngValue||n.value}}}}}),o.directive("auiRefresher",[function(){return{restrict:"E",replace:!0,require:["?^$atajoUiScroll","auiRefresher"],controller:"$atajoUiRefresher",template:'<div class="scroll-refresher invisible" collectaui-repeat-ignore><div class="atajoui-refresher-content" ng-class="{\'atajoui-refresher-with-text\': pullingText || refreshingText}"><div class="icon-pulling" ng-class="{\'pulling-rotataui-disabled\':disablePullingRotation}"><i class="icon {{pullingIcon}}"></i></div><div class="text-pulling" ng-bind-html="pullingText"></div><div class="icon-refreshing"><aui-spinner ng-if="showSpinner" icon="{{spinner}}"></aui-spinner><i ng-if="showIcon" class="icon {{refreshingIcon}}"></i></div><div class="text-refreshing" ng-bind-html="refreshingText"></div></div></div>',link:function(e,t,n,i){var a=i[0],r=i[1];!a||a.isNative()?r.init():(t[0].classList.add("js-scrolling"),a._setRefresher(e,t[0],r.getRefresherDomMethods()),e.$on("scroll.refreshComplete",function(){e.$evalAsync(function(){a.scrollView.finishPullToRefresh()})}))}}}]),o.directive("auiScroll",["$timeout","$controller","$atajoUiBind","$atajoUiConfig",function(e,t,n,i){return{restrict:"E",scope:!0,controller:function(){},compile:function(e,a){function r(e,i,a){n(e,a,{direction:"@",paging:"@",$onScroll:"&onScroll",scroll:"@",scrollbarX:"@",scrollbarY:"@",zooming:"@",minZoom:"@",maxZoom:"@"}),e.direction=e.direction||"y",c(a.padding)&&e.$watch(a.padding,function(e){o.toggleClass("padding",!!e)}),e.$eval(e.paging)===!0&&o.addClass("scroll-paging"),e.direction||(e.direction="y");var r=e.$eval(e.paging)===!0;s&&i.addClass("overflow-scroll"),i.addClass("scroll-"+e.direction);var l={el:i[0],delegateHandle:a.delegateHandle,locking:"true"===(a.locking||"true"),bouncing:e.$eval(a.hasBouncing),paging:r,scrollbarX:e.$eval(e.scrollbarX)!==!1,scrollbarY:e.$eval(e.scrollbarY)!==!1,scrollingX:e.direction.indexOf("x")>=0,scrollingY:e.direction.indexOf("y")>=0,zooming:e.$eval(e.zooming)===!0,maxZoom:e.$eval(e.maxZoom)||3,minZoom:e.$eval(e.minZoom)||.5,preventDefault:!0,nativeScrolling:s};r&&(l.speedMultiplier=.8,l.bouncing=!1),t("$atajoUiScroll",{$scope:e,scrollViewOptions:l})}e.addClass("scroll-view atajoui-scroll");var o=f('<div class="scroll"></div>');o.append(e.contents()),e.append(o);var s="false"!==a.overflowScroll&&("true"===a.overflowScroll||!i.scrolling.jsScrolling());return{pre:r}}}}]),o.directive("auiSideMenu",function(){return{restrict:"E",require:"^auiSideMenus",scope:!0,compile:function(e,t){return angular.isUndefined(t.isEnabled)&&t.$set("isEnabled","true"),angular.isUndefined(t.width)&&t.$set("width","275"),e.addClass("menu menu-"+t.side),function(e,n,i,a){e.side=i.side||"left";var r=a[e.side]=new atajoui.views.SideMenu({width:t.width,el:n[0],isEnabled:!0});e.$watch(i.width,function(e){var t=+e;t&&t==e&&r.setWidth(+e)}),e.$watch(i.isEnabled,function(e){r.setIsEnabled(!!e)})}}}}),o.directive("auiSideMenuContent",["$timeout","$atajoUiGesture","$window",function(e,t,n){return{restrict:"EA",require:"^auiSideMenus",scope:!0,compile:function(i,a){function r(r,o,s,l){function u(e){0!==l.getOpenAmount()?(l.close(),e.gesture.srcEvent.preventDefault(),v=null,g=null):v||(v=atajoui.tap.pointerCoord(e.gesture.srcEvent))}function d(e){l.isDraggableTarget(e)&&"x"==p(e)&&(l._handleDrag(e),e.gesture.srcEvent.preventDefault())}function f(e){"x"==p(e)&&e.gesture.srcEvent.preventDefault()}function h(e){l._endDrag(e),v=null,g=null}function p(e){if(g)return g;if(e&&e.gesture){if(v){var t=atajoui.tap.pointerCoord(e.gesture.srcEvent),n=Math.abs(t.x-v.x),i=Math.abs(t.y-v.y),a=i>n?"y":"x";return Math.max(n,i)>30&&(g=a),a}v=atajoui.tap.pointerCoord(e.gesture.srcEvent)}return"y"}var v=null,g=null;c(a.dragContent)?r.$watch(a.dragContent,function(e){l.canDragContent(e)}):l.canDragContent(!0),c(a.edgeDragThreshold)&&r.$watch(a.edgeDragThreshold,function(e){l.edgeDragThreshold(e)});var m={element:i[0],onDrag:function(){},endDrag:function(){},setCanScroll:function(e){var t=o[0].querySelector(".scroll");if(t){var n=angular.element(t.parentElement);if(n){var i=n.scope();i.scrollCtrl&&i.scrollCtrl.freezeScrollShut(!e)}}},getTranslateX:function(){return r.sideMenuContentTranslateX||0},setTranslateX:atajoui.animationFrameThrottle(function(t){var n=m.offsetX+t;o[0].style[atajoui.CSS.TRANSFORM]="translate3d("+n+"px,0,0)",e(function(){r.sideMenuContentTranslateX=t})}),setMarginLeft:atajoui.animationFrameThrottle(function(e){e?(e=parseInt(e,10),o[0].style[atajoui.CSS.TRANSFORM]="translate3d("+e+"px,0,0)",o[0].style.width=n.innerWidth-e+"px",m.offsetX=e):(o[0].style[atajoui.CSS.TRANSFORM]="translate3d(0,0,0)",o[0].style.width="",m.offsetX=0)}),setMarginRight:atajoui.animationFrameThrottle(function(e){e?(e=parseInt(e,10),o[0].style.width=n.innerWidth-e+"px",m.offsetX=e):(o[0].style.width="",m.offsetX=0),o[0].style[atajoui.CSS.TRANSFORM]="translate3d(0,0,0)"}),setMarginLeftAndRight:atajoui.animationFrameThrottle(function(e,t){e=e&&parseInt(e,10)||0,t=t&&parseInt(t,10)||0;var i=e+t;i>0?(o[0].style[atajoui.CSS.TRANSFORM]="translate3d("+e+"px,0,0)",o[0].style.width=n.innerWidth-i+"px",m.offsetX=e):(o[0].style[atajoui.CSS.TRANSFORM]="translate3d(0,0,0)",o[0].style.width="",m.offsetX=0)}),enableAnimation:function(){r.animationEnabled=!0,o[0].classList.add("menu-animated")},disableAnimation:function(){r.animationEnabled=!1,o[0].classList.remove("menu-animated")},offsetX:0};l.setContent(m);var $={stop_browser_behavior:!1};$.prevent_default_directions=["left","right"];var w=t.on("tap",u,o,$),b=t.on("dragright",d,o,$),y=t.on("dragleft",d,o,$),S=t.on("dragup",f,o,$),k=t.on("dragdown",f,o,$),C=t.on("release",h,o,$);r.$on("$destroy",function(){m&&(m.element=null,m=null),t.off(y,"dragleft",d),t.off(b,"dragright",d),t.off(S,"dragup",f),t.off(k,"dragdown",f),t.off(C,"release",h),t.off(w,"tap",u)})}return i.addClass("menu-content pane"),{pre:r}}}}]),o.directive("auiSideMenus",["$atajoUiBody",function(e){return{restrict:"ECA",controller:"$atajoUiSideMenus",compile:function(t,n){function i(t,n,i,a){a.enableMenuWithBackViews(t.$eval(i.enableMenuWithBackViews)),t.$on("$atajoUiExposeAside",function(n,i){t.$exposeAside||(t.$exposeAside={}),t.$exposeAside.active=i,e.enableClass(i,"aside-open")}),t.$on("$atajoUiView.beforeEnter",function(e,n){n.historyId&&(t.$activeHistoryId=n.historyId)}),t.$on("$destroy",function(){e.removeClass("menu-open","aside-open")})}return n.$set("class",(n["class"]||"")+" view"),{pre:i}}}}]),o.directive("auiSlideBox",["$animate","$timeout","$compile","$atajoUiSlideBoxDelegate","$atajoUiHistory","$atajoUiScrollDelegate",function(e,t,n,i,a,r){return{restrict:"E",replace:!0,transclude:!0,scope:{autoPlay:"=",doesContinue:"@",slideInterval:"@",showPager:"@",pagerClick:"&",disableScroll:"@",onSlideChanged:"&",activeSlide:"=?",bounce:"@"},controller:["$scope","$element","$attrs",function(e,n,o){function s(e){e&&!l.isScrollFreeze?r.freezeAllScrolls(e):!e&&l.isScrollFreeze&&r.freezeAllScrolls(!1),l.isScrollFreeze=e}var l=this,u=e.$eval(e.doesContinue)===!0,d=e.$eval(e.bounce)!==!1,f=c(o.autoPlay)?!!e.autoPlay:!1,h=f?e.$eval(e.slideInterval)||4e3:0,p=new atajoui.views.Slider({el:n[0],auto:h,continuous:u,startSlide:e.activeSlide,bouncing:d,slidesChanged:function(){e.currentSlide=p.currentIndex(),t(function(){})},callback:function(n){e.currentSlide=n,e.onSlideChanged({index:e.currentSlide,$index:e.currentSlide}),e.$parent.$broadcast("slideBox.slideChanged",n),e.activeSlide=n,t(function(){})},onDrag:function(){s(!0)},onDragEnd:function(){s(!1)}});p.enableSlide(e.$eval(o.disableScroll)!==!0),e.$watch("activeSlide",function(e){c(e)&&p.slide(e)}),e.$on("slideBox.nextSlide",function(){p.next()}),e.$on("slideBox.prevSlide",function(){p.prev()}),e.$on("slideBox.setSlide",function(e,t){p.slide(t)}),this.__slider=p;var v=i._registerInstance(p,o.delegateHandle,function(){return a.isActiveScope(e)});e.$on("$destroy",function(){v(),p.kill()}),this.slidesCount=function(){return p.slidesCount()},this.onPagerClick=function(t){e.pagerClick({index:t})},t(function(){p.load()})}],template:'<div class="slider"><div class="slider-slides" ng-transclude></div></div>',link:function(t,i,a){function r(){if(!o){var e=t.$new();o=f("<aui-pager></aui-pager>"),i.append(o),o=n(o)(e)}return o}e.enabled(i,!1),c(a.showPager)||(t.showPager=!0,r().toggleClass("hide",!1)),a.$observe("showPager",function(e){void 0!==e&&(e=t.$eval(e),r().toggleClass("hide",!e))});var o}}}]).directive("auiSlide",function(){return{restrict:"E",require:"?^auiSlideBox",compile:function(e){e.addClass("slider-slide")}}}).directive("auiPager",function(){return{restrict:"E",replace:!0,require:"^auiSlideBox",template:'<div class="slider-pager"><span class="slider-pager-page" ng-repeat="slide in numSlides() track by $index" ng-class="{active: $index == currentSlide}" ng-click="pagerClick($index)"><i class="icon aui-record"></i></span></div>',link:function(e,t,n,i){var a=function(e){for(var n=t[0].children,i=n.length,a=0;i>a;a++)a==e?n[a].classList.add("active"):n[a].classList.remove("active")};e.pagerClick=function(e){i.onPagerClick(e)},e.numSlides=function(){return new Array(i.slidesCount())},e.$watch("currentSlide",function(e){a(e)})}}}),o.directive("auiSlides",["$animate","$timeout","$compile",function(e,t,n){return{restrict:"E",transclude:!0,scope:{options:"=",slider:"="},template:'<div class="swiper-container"><div class="swiper-wrapper" ng-transclude></div><div ng-hide="!showPager" class="swiper-pagination"></div></div>',controller:["$scope","$element",function(e,i){var a=this;this.update=function(){t(function(){if(a.__slider){a.__slider.update(),a._options.loop&&a.__slider.createLoop();var t=a.__slider.slides.length;t>10&&(e.showPager=!1),a.__slider.activeIndex>t-1&&a.__slider.slideTo(t-1)}})},this.rapidUpdate=atajoui.debounce(function(){a.update()},50),this.getSlider=function(){return a.__slider};var r=e.options||{},o=angular.extend({pagination:i.children().children()[1],paginationClickable:!0,lazyLoading:!0,preloadImages:!1},r);this._options=o,t(function(){var t=new atajoui.views.Swiper(i.children()[0],o,e,n);e.$emit("$atajoUiSlides.sliderInitialized",{slider:t}),a.__slider=t,e.slider=a.__slider,e.$on("$destroy",function(){t.destroy(),a.__slider=null})}),t(function(){a.rapidUpdate()},200)}],link:function(e){e.showPager=!0}}}]).directive("auiSlidePage",[function(){return{restrict:"E",require:"?^auiSlides",transclude:!0,replace:!0,template:'<div class="swiper-slide" ng-transclude></div>',link:function(e,t,n,i){i.rapidUpdate(),e.$on("$destroy",function(){i.rapidUpdate()})}}}]),o.directive("auiSpinner",function(){return{restrict:"E",controller:"$atajoUiSpinner",link:function(e,t,n,i){var a=i.init();t.addClass("spinner spinner-"+a),t.on("$destroy",function(){i.stop()})}}}),o.directive("auiTab",["$compile","$atajoUiConfig","$atajoUiBind","$atajoUiViewSwitcher",function(e,t,n,i){function a(e,t){return c(t)?" "+e+'="'+t+'"':""}return{restrict:"E",require:["^auiTabs","auiTab"],controller:"$atajoUiTab",scope:!0,compile:function(r,o){for(var s="<aui-tab-nav"+a("ng-click",o.ngClick)+a("title",o.title)+a("icon",o.icon)+a("icon-on",o.iconOn)+a("icon-off",o.iconOff)+a("badge",o.badge)+a("badge-style",o.badgeStyle)+a("hidden",o.hidden)+a("disabled",o.disabled)+a("class",o["class"])+"></aui-tab-nav>",l=document.createElement("div"),c=0;c<r[0].children.length;c++)l.appendChild(r[0].children[c].cloneNode(!0));var u=l.childElementCount;r.empty();var d,h;return u&&("AUI-NAV-VIEW"===l.children[0].tagName&&(d=l.children[0].getAttribute("name"),l.children[0].classList.add("view-container"),h=!0),1===u&&(l=l.children[0]),h||l.classList.add("pane"),l.classList.add("tab-content")),function(a,r,o,c){function h(){w.tabMatchesState()&&$.select(a,!1)}function p(n){n&&u?(b||(g=a.$new(),m=f(l),i.viewEleIsActive(m,!0),$.$element.append(m),e(m)(g),b=!0),i.viewEleIsActive(m,!0)):b&&m&&(t.views.maxCache()>0?i.viewEleIsActive(m,!1):v())}function v(){g&&g.$destroy(),b&&m&&m.remove(),l.innerHTML="",b=g=m=null}var g,m,$=c[0],w=c[1],b=!1;a.$tabSelected=!1,n(a,o,{onSelect:"&",onDeselect:"&",title:"@",uiSref:"@",href:"@"}),$.add(a),a.$on("$destroy",function(){a.$tabsDestroy||$.remove(a),y.isolateScope().$destroy(),y.remove(),y=l=m=null}),r[0].removeAttribute("title"),d&&(w.navViewName=a.navViewName=d),a.$on("$stateChangeSuccess",h),h();var y=f(s);y.data("$auiTabsController",$),y.data("$auiTabController",w),$.$tabsElement.append(e(y)(a)),a.$watch("$tabSelected",p),a.$on("$atajoUiView.afterEnter",function(){i.viewEleIsActive(m,a.$tabSelected)}),a.$on("$atajoUiView.clearCache",function(){a.$tabSelected||v()})}}}}]),o.directive("auiTabNav",[function(){return{restrict:"E",replace:!0,require:["^auiTabs","^auiTab"],template:"<a ng-class=\"{'has-badge':badge, 'tab-hidden':isHidden(), 'tab-item-active': isTabActive()}\" "+' ng-disabled="disabled()" class="tab-item"><span class="badge {{badgeStyle}}" ng-if="badge">{{badge}}</span><i class="icon {{getIcon()}}" ng-if="getIcon()"></i><span class="tab-title" ng-bind-html="title"></span></a>',scope:{title:"@",icon:"@",iconOn:"@",iconOff:"@",badge:"=",hidden:"@",disabled:"&",badgeStyle:"@","class":"@"},link:function(e,t,n,i){var a=i[0],r=i[1];t[0].removeAttribute("title"),e.selectTab=function(e){e.preventDefault(),a.select(r.$scope,!0)},n.ngClick||t.on("click",function(t){e.$apply(function(){e.selectTab(t)})}),e.isHidden=function(){return"true"===n.hidden||n.hidden===!0?!0:!1},e.getIconOn=function(){return e.iconOn||e.icon},e.getIconOff=function(){return e.iconOff||e.icon},e.isTabActive=function(){return a.selectedTab()===r.$scope},e.getIcon=function(){return a.selectedTab()===r.$scope?e.iconOn||e.icon:e.iconOff||e.icon}}}}]),o.directive("auiTabs",["$atajoUiTabsDelegate","$atajoUiConfig",function(e,t){return{restrict:"E",scope:!0,controller:"$atajoUiTabs",compile:function(n){function i(t,n,i,a){function o(e,t){e.stopPropagation();var n=a.previousSelectedTab();n&&n.$broadcast(e.name.replace("NavView","Tabs"),t)}var s=e._registerInstance(a,i.delegateHandle,a.hasActiveScope);a.$scope=t,a.$element=n,a.$tabsElement=f(n[0].querySelector(".tabs")),t.$watch(function(){return n[0].className},function(e){var n=-1!==e.indexOf("tabs-top"),i=-1!==e.indexOf("tabs-item-hide");t.$hasTabs=!n&&!i,t.$hasTabsTop=n&&!i,t.$emit("$atajoUiTabs.top",t.$hasTabsTop)}),t.$on("$atajoUiNavView.beforeLeave",o),t.$on("$atajoUiNavView.afterLeave",o),t.$on("$atajoUiNavView.leave",o),t.$on("$destroy",function(){t.$tabsDestroy=!0,s(),a.$tabsElement=a.$element=a.$scope=r=null,delete t.$hasTabs,delete t.$hasTabsTop})}function a(e,t,n,i){i.selectedTab()||i.select(0)}var r=f('<div class="tab-nav tabs">');return r.append(n.contents()),n.append(r).addClass("tabs-"+t.tabs.position()+" tabs-"+t.tabs.style()),{pre:i,post:a}}}}]),o.directive("auiTitle",[function(){return{restrict:"E",compile:function(e){e.addClass("title")}}}]),o.directive("auiToggle",["$timeout","$atajoUiConfig",function(e,t){return{restrict:"E",replace:!0,require:"?ngModel",transclude:!0,template:'<div class="item item-toggle"><div ng-transclude></div><label class="toggle"><input type="checkbox"><div class="track"><div class="handle"></div></div></label></div>',compile:function(e,n){var i=e.find("input");return l({name:n.name,"ng-value":n.ngValue,"ng-model":n.ngModel,"ng-checked":n.ngChecked,"ng-disabled":n.ngDisabled,"ng-true-value":n.ngTrueValue,"ng-false-value":n.ngFalseValue,"ng-change":n.ngChange,"ng-required":n.ngRequired,required:n.required},function(e,t){c(e)&&i.attr(t,e)}),n.toggleClass&&e[0].getElementsByTagName("label")[0].classList.add(n.toggleClass),e.addClass("toggle-"+t.form.toggle()),function(e,t){var n=t[0].getElementsByTagName("label")[0],i=n.children[0],a=n.children[1],r=a.children[0],o=f(i).controller("ngModel");e.toggle=new atajoui.views.Toggle({el:n,track:a,checkbox:i,handle:r,onChange:function(){o&&(o.$setViewValue(i.checked),e.$apply())}}),e.$on("$destroy",function(){e.toggle.destroy()})}}}}]),o.directive("auiView",function(){return{restrict:"EA",priority:1e3,controller:"$atajoUiView",compile:function(e){return e.addClass("pane"),e[0].removeAttribute("title"),function(e,t,n,i){i.init()}}}})}();